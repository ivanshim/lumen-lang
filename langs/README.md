...
15. Statement forms are fixed by the kernel: `stmt.let` introduces a binding
    ...
    end` or `builtin.range(start, end)`, not a value; `stmt.function` takes a name, a parenthesised
...
| `op.index.open` | `[` | `[` | `[` | `[` | `[` | `[` | `[` | `[` | `[` |
| `op.index.close` | `]` | `]` | `]` | `]` | `]` | `]` | `]` | `]` | `]` |
| `op.index.strings` | `false` | `true` | `false` | `false` | `true` | `false` | `true` | `true` | `false` |
| `op.pipe` | `\|>` | `.` | `.` | - | `.` | - | - | `.` | `.` |
| `stmt.assign` | `=` | `=` | `=` | `=` | `=` | `:=` | `=` | `=` | `=` |
...
| `stmt.foreach.as` | - | - | - | - | - | - | - | - | - |
| `stmt.foreach.pair` | - | - | - | - | - | - | - | - | - |
| `stmt.return` | `return` | `return` | `return` | `return` | `return` | `exit` | `return` | `return` | `return` |
...
| `stmt.function.result_by_name` | `false` | `false` | `false` | `false` | `false` | `true` | `false` | `false` | `false` |
| `stmt.pass` | - | `pass` | - | - | - | - | - | - | - |
| `stmt.emit` | - | - | - | - | - | - | - | - | - |
| `builtin.emit` | `emit` | `sys.stdout.write` | - | - | `process.stdout.write` | - | - | - | - |
| `builtin.print` | (library: `print`) | `print` | `println!` | `puts` | `console.log` | `writeln` | - | `puts` | `print` |
| `builtin.write` | (library: `write`) | - | `print!` | `printf` | - | `write` | `print` | `print` | - |
| `builtin.print.placeholder` | - | - | `{}` | `%d` `%ld` `%f` `%lf` `%s` `%c` | - | - | - | - | - |
| `builtin.len` | `len` | `len` | `len` | `strlen` | `length` | `length` | `count` `strlen` | `length` `size` | `count` |
| `builtin.char_at` | `char_at` | - | - | - | `charAt` | - | - | - | - |
| `builtin.ord` | `ord` | `ord` | - | - | - | `ord` | `ord` | `ord` | - |
| `builtin.chr` | `chr` | `chr` | - | - | `String.fromCharCode` | `chr` | `chr` | `chr` | - |
...
| `builtin.num` | `num` | - | - | - | - | - | - | - | - |
| `builtin.den` | `den` | - | - | - | - | - | - | - | - |
| `builtin.push` | `push` | `append` | `push` | - | `push` | - | `array_push` | `push` | `append` |
| `builtin.precision` | `precision` | - | - | - | - | - | - | - | - |
| `builtin.to_string` | (library: `value_to_string`) | `str` | `to_string` | - | `String` | - | `strval` | `to_s` `String` | `String` |
| `builtin.to_int` | (library: `int`) | `int` | - | - | `Math.trunc` | - | `intval` | `to_i` `Integer` | `Int` |
| `builtin.to_real` | (library: `real_default`) | `float` | - | - | `Number` | - | `floatval` | `to_f` `Float` | `Double` |
