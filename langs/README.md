...
| `builtin.write` | - | - | `print!` | `printf` | - | `write` | `print` | `print` | - |
...
| `builtin.to_string` | - | `str` | `to_string` | - | `String` | - | `strval` | `to_s` `String` | `String` |
| `builtin.to_int` | - | `int` | - | - | `Math.trunc` | - | `intval` | `to_i` `Integer` | `Int` |
| `builtin.to_real` | - | `float` | - | - | `Number` | - | `floatval` | `to_f` `Float` | `Double` |
