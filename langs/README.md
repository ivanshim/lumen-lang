...
- `ext.op.object.unary`: the methods for negation, conversion to a whole
  number, and conversion to a real, in that order. Each is called with
  its owner alone.
...
| `system.kind.integer` | `INTEGER` | `INTEGER` | `int` | - | `integer` | - | - | - | - | - |
| `system.kind.rational` | `RATIONAL` | `RATIONAL` | - | - | - | - | - | - | - | - |
| `system.kind.real` | `REAL` | `REAL` | `float` | - | `double` | - | - | - | - | - |
| `system.kind.string` | `STRING` | `STRING` | `str` | - | `string` | - | - | - | - | - |
| `system.kind.boolean` | `BOOLEAN` | `BOOLEAN` | `bool` | - | `boolean` | - | - | - | - | - |
| `system.kind.array` | `ARRAY` | `ARRAY` | `list` | - | `array` | - | - | - | - | - |
...
| `ext.op.object.unary` | - | - | `__neg__` `__int__` `__float__` | - | - | - | - | - | - | - |
| `ext.op.otherwise` | - | - | - | - | `??` | - | - | - | - | - |
| `ext.op.plus` | - | - | `+` | - | `+` | - | - | - | - | - |
| `ext.op.reference` | - | - | - | - | `&` | - | - | - | - | - |
