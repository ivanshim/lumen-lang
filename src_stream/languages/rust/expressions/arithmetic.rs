...
use crate::languages::rust::registry::{ExprInfix, ExprPrefix, Precedence, Registry};
use crate::kernel::runtime::{Env, Value};
use crate::languages::rust::numeric;
use crate::languages::rust::values::{RustNumber, as_number};
...
impl ExprNode for UnaryMinusExpr {
    fn eval(&self, env: &mut Env) -> LumenResult<Value> {
        ...
        Ok(Box::new(RustNumber::new(result)))
    }
}
