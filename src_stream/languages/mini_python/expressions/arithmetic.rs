...
use crate::src_stream::src_stream::kernel::registry::{ExprInfix, ExprPrefix, LumenResult, Precedence, Registry};
use crate::src_stream::src_stream::kernel::runtime::{Env, Value};
use crate::src_stream::src_mini_python::numeric;
use crate::src_stream::src_mini_python::values::{MiniPythonNumber, as_number};
...
impl ExprNode for UnaryMinusExpr {
    fn eval(&self, env: &mut Env) -> LumenResult<Value> {
        ...
        Ok(Box::new(MiniPythonNumber::new(result)))
    }
}
