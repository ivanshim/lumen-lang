...
# lumen-lang Lumen test script
# Tests Lumen examples with both stream and microcode kernels
# Output is displayed directly, not captured
# Results are summarized by kernel type
...
echo "=========================================="
echo "  Lumen-Lang Test Suite (Lumen Only)"
echo "=========================================="
echo ""
