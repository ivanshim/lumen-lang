...
print(round(x= 1.235, decimals= 2))
sys.stdout.write("round(1.234, 2) = ")
print(round(x= 1.234, decimals= 2))
sys.stdout.write("round(1.245, 2) = ")
print(round(x= 1.245, decimals= 2))
sys.stdout.write("round(1.5, 0) = ")
print(round(x= 1.5, decimals= 0))
sys.stdout.write("round(2.5, 0) = ")
print(round(x= 2.5, decimals= 0))
