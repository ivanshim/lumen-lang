...
ch_valid = char_at_or_null(s= text, index= 1)
sys.stdout.write("char_at_or_null('Lumen', 1): ")
print(ch_valid)
ch_oob = char_at_or_null(s= text, index= 10)
sys.stdout.write("char_at_or_null('Lumen', 10) [out of bounds]: ")
print(ch_oob)
ch_neg = char_at_or_null(s= text, index= -1)
sys.stdout.write("char_at_or_null('Lumen', -1) [negative]: ")
print(ch_neg)
ch_edge = char_at_or_null(s= text, index= 5)
