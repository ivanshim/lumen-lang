...
| `php/func` | 14 | pass 1, differs 0, error 13, skipped 0 | pass 1, differs 0, error 13, skipped 0 |
| `php/lang` | 213 | pass 11, differs 1, error 199, skipped 2 | pass 11, differs 1, error 199, skipped 2 |
...
| `php/lang/string` | 9 | pass 0, differs 0, error 9, skipped 0 | pass 0, differs 0, error 9, skipped 0 |
| all | 422 | pass 18, differs 2, error 400, skipped 2 | pass 18, differs 2, error 400, skipped 2 |
...
| Unexpected token: + | 9 |
| Undefined variable: ini_get | 8 |
| Undefined variable: class | 8 |
| Undefined variable: define | 8 |
| Undefined variable: array | 7 |
| Undefined variable: error_reporting | 6 |
...
### Reserved words: 13 of 68 spelled

Spelled: `and`, `break`, `continue`, `echo`, `else`, `elseif`, `exit`, `function`, `if`, `or`, `print`, `return`, `while`

Not spelled: `abstract`, `array`, `as`, `callable`, `case`, `catch`, `class`, `clone`, `const`, `declare`, `default`, `do`, `empty`, `enddeclare`, `endfor`, `endforeach`, `endif`, `endswitch`, `endwhile`, `eval`, `extends`, `final`, `finally`, `fn`, `for`, `foreach`, `global`, `goto`, `implements`, `include`, `include_once`, `instanceof`, `insteadof`, `interface`, `isset`, `list`, `match`, `namespace`, `new`, `private`, `protected`, `public`, `readonly`, `require`, `require_once`, `static`, `switch`, `throw`, `trait`, `try`, `unset`, `use`, `var`, `xor`, `yield`
...
| `php/basic/011.phpt` | error | error | Unexpected token: = |
...
| `php/basic/011_windows.phpt` | error | error | Unexpected token: = |
| `php/basic/012.phpt` | error | error | Unexpected token: = |
...
| `php/basic/bug54514.phpt` | error | error | Unexpected token: = |
...
| `php/basic/bug73969.phpt` | error | error | Unexpected character ':' |
...
| `php/basic/bug80384.phpt` | error | error | Unexpected token: = |
...
| `php/basic/enable_post_data_reading_05.phpt` | error | error | Unexpected character '?' |
| `php/basic/enable_post_data_reading_06.phpt` | error | error | Unexpected character '?' |
| `php/basic/enable_post_data_reading_07.phpt` | error | error | Unexpected character '?' |
...
| `php/basic/gh17951_runtime_change_6.phpt` | error | error | Unexpected token: = |
| `php/basic/gh20858.phpt` | error | error | Unexpected token: = |
...
| `php/basic/precision.phpt` | error | error | Undefined variable: e100 |
...
| `php/basic/timeout_variation_0.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_1.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_10.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_2.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_4.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_7.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_8.phpt` | error | error | Unexpected character '?' |
| `php/basic/timeout_variation_9.phpt` | error | error | Unexpected character '?' |
| `php/func/001.phpt` | pass | pass |  |
| `php/func/002.phpt` | error | error | Unexpected token: , |
| `php/func/003.phpt` | error | error | Unexpected token: = |
| `php/func/004.phpt` | error | error | Unexpected token: = |
| `php/func/005.phpt` | error | error | Undefined variable: register_shutdown_function |
| `php/func/005a.phpt` | error | error | Unexpected token: ; |
| `php/func/006.phpt` | error | error | Undefined variable: ob_start |
| `php/func/007.phpt` | error | error | Unexpected token: = |
| `php/func/008.phpt` | error | error | Undefined variable: var_export |
| `php/func/009.phpt` | error | error | Undefined variable: var_export |
| `php/func/010.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/003.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/008.phpt` | error | error | Unexpected character ':' |
| `php/lang/009.phpt` | pass | pass |  |
| `php/lang/010.phpt` | pass | pass |  |
| `php/lang/011.phpt` | error | error | Undefined variable: static |
...
| `php/lang/018.phpt` | error | error | Unexpected token: = |
| `php/lang/019.phpt` | error | error | Undefined variable: eval |
| `php/lang/020.phpt` | error | error | Unexpected character ':' |
| `php/lang/021.phpt` | error | error | Unexpected character ':' |
| `php/lang/022.phpt` | error | error | Unexpected character ':' |
| `php/lang/023.phpt` | error | error | Unexpected character '?' |
| `php/lang/024.phpt` | error | error | Unexpected character '?' |
| `php/lang/025.phpt` | pass | pass |  |
| `php/lang/026.phpt` | pass | pass |  |
| `php/lang/027.phpt` | error | error | Expected '{' to open a block, got 'EOF' |
...
| `php/lang/033.phpt` | error | error | Unexpected character ':' |
| `php/lang/034.phpt` | error | error | Unexpected token: , |
| `php/lang/035.phpt` | error | error | Unexpected token: > |
| `php/lang/036.phpt` | error | error | Unexpected character ':' |
| `php/lang/037.phpt` | error | error | Unexpected token: > |
| `php/lang/038.phpt` | error | error | Unexpected character ':' |
| `php/lang/039.phpt` | error | error | Unexpected character ':' |
| `php/lang/040.phpt` | error | error | Undefined variable: array |
| `php/lang/041.phpt` | error | error | Unexpected character ':' |
| `php/lang/042.phpt` | error | error | Unexpected character ':' |
| `php/lang/043.phpt` | error | error | Unexpected character ':' |
| `php/lang/044.phpt` | error | error | Unexpected character ':' |
| `php/lang/045.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/bug18872.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/bug21849.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/bug23384.phpt` | error | error | Unexpected character ':' |
| `php/lang/bug23489.phpt` | error | error | Unexpected character '?' |
| `php/lang/bug23524.phpt` | error | error | Expected identifier as a parameter name, got '=' |
| `php/lang/bug23584.phpt` | error | error | Unexpected character '?' |
| `php/lang/bug23624.phpt` | error | error | Unexpected token: = |
| `php/lang/bug24054.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/bug24640.phpt` | error | error | Undefined variable: e |
...
| `php/lang/bug24908.phpt` | error | error | Expected '{' to open a block, got 'echo' |
...
| `php/lang/bug26696.phpt` | error | error | Unexpected character ':' |
| `php/lang/bug26866.phpt` | error | error | Unexpected token: > |
| `php/lang/bug26869.phpt` | error | error | Unexpected token: = |
| `php/lang/bug27354.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/bug27439.phpt` | error | error | Unexpected token: > |
| `php/lang/bug27443.phpt` | error | error | Undefined variable: defined |
| `php/lang/bug27535.phpt` | error | error | Unexpected character '?' |
| `php/lang/bug28213.phpt` | error | error | Undefined variable: class |
| `php/lang/bug28800.phpt` | error | error | Unexpected character '\' |
| `php/lang/bug29566.phpt` | error | error | Undefined variable: unset |
| `php/lang/bug29893.phpt` | error | error | Unexpected character ':' |
| `php/lang/bug29944.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/bug30862.phpt` | error | error | Unexpected character ':' |
| `php/lang/bug32828.phpt` | error | error | Undefined variable: ob_start |
| `php/lang/bug32924.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/bug43958.phpt` | error | error | Unexpected character ':' |
| `php/lang/bug44654.phpt` | error | error | Unexpected character '?' |
| `php/lang/bug44827.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/bug73172.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/catchable_error_002.phpt` | error | error | Unexpected character ':' |
| `php/lang/comments.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/engine_assignExecutionOrder_002.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/execution_order.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/foreachLoopIterator.001.phpt` | error | error | Unexpected character ':' |
| `php/lang/foreachLoopIterator.002.phpt` | error | error | Unexpected character ':' |
| `php/lang/foreachLoopIteratorAggregate.001.phpt` | error | error | Unexpected character ':' |
| `php/lang/foreachLoopIteratorAggregate.002.phpt` | error | error | Unexpected character ':' |
| `php/lang/foreachLoopIteratorAggregate.003.phpt` | error | error | Unexpected character ':' |
| `php/lang/foreachLoopIteratorAggregate.004.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/func_num_args.003.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/integer_literals/hexadecimal_32bit.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/integer_literals/hexadecimal_64bit.phpt` | error | error | Undefined variable: var_dump |
...
| `php/lang/operators/add_basiclong_64bit.phpt` | error | error | Undefined variable: define |
...
| `php/lang/operators/bitwiseShiftLeft_basiclong_64bit.phpt` | error | error | Unexpected character ':' |
| `php/lang/operators/bitwiseShiftLeft_variationStr.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/operators/bitwiseShiftRight_basiclong_64bit.phpt` | error | error | Unexpected character ':' |
...
| `php/lang/operators/coalesce.phpt` | error | error | Unexpected character '?' |
...
| `php/lang/operators/modulus_basiclong_64bit.phpt` | error | error | Unexpected character ':' |
| `php/lang/operators/modulus_variationStr.phpt` | error | error | Unexpected character '\' |
| `php/lang/operators/multiply_basiclong_64bit.phpt` | error | error | Undefined variable: define |
...
| `php/lang/operators/negate_basiclong_64bit.phpt` | error | error | Undefined variable: define |
| `php/lang/operators/negate_variationStr.phpt` | error | error | Unexpected character '\' |
| `php/lang/operators/operator_equals_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_equals_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_equals_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_gt_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_gt_or_equal_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_gt_or_equal_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_gt_or_equal_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_gt_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_gt_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_identical_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_identical_recusion-01.phpt` | error | error | Unexpected character '&' |
| `php/lang/operators/operator_identical_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_identical_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_lt_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_lt_or_equal_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_lt_or_equal_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_lt_or_equal_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_lt_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_lt_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_notequals_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_notequals_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_notequals_variation_64bit.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_notidentical_basic.phpt` | error | error | Unexpected token: + |
| `php/lang/operators/operator_notidentical_variation.phpt` | error | error | Unexpected token: = |
| `php/lang/operators/operator_notidentical_variation_64bit.phpt` | error | error | Unexpected token: = |
...
| `php/lang/operators/postdec_basiclong_64bit.phpt` | error | error | Undefined variable: define |
| `php/lang/operators/postdec_variationStr.phpt` | error | error | Undefined variable: array |
| `php/lang/operators/postinc_basiclong_64bit.phpt` | error | error | Undefined variable: define |
| `php/lang/operators/postinc_variationStr.phpt` | error | error | Undefined variable: array |
| `php/lang/operators/predec_basiclong_64bit.phpt` | error | error | Undefined variable: define |
| `php/lang/operators/predec_variationStr.phpt` | error | error | Undefined variable: array |
| `php/lang/operators/preinc_basiclong_64bit.phpt` | error | error | Undefined variable: define |
| `php/lang/operators/preinc_variationStr.phpt` | error | error | Undefined variable: array |
| `php/lang/operators/subtract_basiclong_64bit.phpt` | error | error | Undefined variable: define |
...
| `php/lang/short_tags.001.phpt` | error | error | Unexpected character '?' |
| `php/lang/short_tags.002.phpt` | error | error | Unexpected character '?' |
| `php/lang/short_tags.004.phpt` | error | error | Unexpected character '?' |
| `php/lang/static_basic_001.phpt` | error | error | Unexpected token: , |
| `php/lang/static_basic_002.phpt` | error | error | Undefined variable: static |
| `php/lang/static_variation_001.phpt` | error | error | Undefined variable: static |
| `php/lang/static_variation_002.phpt` | error | error | Unexpected character ':' |
| `php/lang/string/unicode_escape.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_empty.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_incomplete.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_large_codepoint.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_legacy.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_sign.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_sign2.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string/unicode_escape_surrogates.phpt` | error | error | Undefined variable: bin2hex |
| `php/lang/string/unicode_escape_whitespace.phpt` | error | error | Undefined variable: var_dump |
| `php/lang/string_decimals_001.phpt` | error | error | --> Testing ..9: |
| `php/lang/syntax_errors.phpt` | error | error | Unexpected character ':' |
