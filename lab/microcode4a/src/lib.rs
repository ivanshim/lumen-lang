// Lab specimen: microcode4 with the kernel lab's count-neutral
// improvements woven in and nothing else. Still the four forms; see
// docs/KERNEL_LAB.md, "The references at equal engineering".
//
