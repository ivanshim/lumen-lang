...
impl Writer<'_> {
    ...
    pub fn representation(&self, value: &Value, ascii: bool) -> Result<String> {
        ...
        match value {
            ...
            // Every other value stands in a field as it stands
            // wherever else it is written out: by the words the
            // language keeps for it. A field refuses nothing a plain
            // writing would have shown.
            other => Ok(other.display(&self.words)),
        }
    }
