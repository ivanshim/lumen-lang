...
pub enum Builtin {
    ...
    ValueMethod,
    Sorted,
    InstanceOf, Set, Dict, Reversed, Enumerate, Zip, Map, Filter, All, Minimum, Maximum, Absolute, Round, Divmod, Power, Hex, Oct, Bin, Repr, Format, Bool, Callable, Identity, Hash, HasAttr, GetAttr, SetAttr, DelAttr, Vars,
    Bytes(u8),
    Sum,
    List,
    Any,
