...
pub struct Lang {
    ...
    pub catch_amiss: Vec<String>,
    pub catch_group_amiss: Vec<String>,
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("builtin.precision", Builtin::Places), ("ext.builtin.exceptions.info", Builtin::ExceptionInfo), ("ext.builtin.exceptions.current", Builtin::ExceptionCurrent), ("ext.builtin.repr", Builtin::Repr), ("builtin.to_string", Builtin::ToText),
        ...
        let mut lang = Lang {
            ...
            fault_trace: r.strings("ext.system.fault.trace")?,
            os_message: r.strings("ext.builtin.exceptions.os.message")?,
            group_summary: r.strings("ext.builtin.exceptions.group.summary")?,
            catch_amiss: r.strings("ext.stmt.catch.amiss")?,
            catch_group_amiss: r.strings("ext.stmt.catch.group.amiss")?,
            ...
            yield_escaped: r.strings("ext.stmt.yield.escaped")?,
