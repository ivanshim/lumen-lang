...
pub struct Lang {
    pub builtin_source_parameters: Vec<String>,
    pub builtin_compile_parameters: Vec<String>,
    pub builtin_compile_modes: Vec<String>,
    pub builtin_compile_kind: Vec<String>,
    pub builtin_source_unready: Vec<String>,
    pub builtin_source_syntax: Vec<String>,
    pub builtin_scope_unready: Vec<String>,
    pub builtin_input_eof: Vec<String>,
    pub builtin_import_unready: Vec<String>,
    pub system_fault_class_name: Vec<String>,
    pub system_name_absent: Vec<String>,
    pub system_module_builtins: Vec<String>,
    pub system_module_doc: Vec<String>,
    pub system_class_name: Vec<String>,
    pub builtin_globals: Vec<String>,
    pub builtin_locals: Vec<String>,
    pub builtin_vars: Vec<String>,
    pub builtin_exec: Vec<String>,
    pub builtin_compile: Vec<String>,
    pub builtin_dir: Vec<String>,
    pub builtin_id: Vec<String>,
    pub builtin_hash: Vec<String>,
    pub builtin_input: Vec<String>,
    pub builtin_breakpoint: Vec<String>,
    pub builtin_help: Vec<String>,
    pub builtin_import: Vec<String>,
    pub builtin_sorted: Vec<String>,
...
w ext.builtin.source.parameters | w ext.builtin.compile.parameters | w ext.builtin.compile.modes | w ext.builtin.compile.kind | w ext.builtin.source.unready | w ext.builtin.source.syntax | w ext.builtin.scope.unready | w ext.builtin.input.eof | w ext.builtin.import.unready | w ext.system.fault.class.name | w ext.system.name.absent | w ext.system.module.builtins | w ext.system.module.doc | w ext.system.class.name | w ext.builtin.globals | w ext.builtin.locals | w ext.builtin.vars | w ext.builtin.exec | w ext.builtin.compile | w ext.builtin.dir | w ext.builtin.id | w ext.builtin.hash | w ext.builtin.input | w ext.builtin.breakpoint | w ext.builtin.help | w ext.builtin.import | w ext.builtin.sorted
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("ext.builtin.globals", Builtin::GlobalNames), ("ext.builtin.locals", Builtin::LocalNames), ("ext.builtin.vars", Builtin::Vars), ("ext.builtin.exec", Builtin::Exec), ("ext.builtin.compile", Builtin::Compile), ("ext.builtin.dir", Builtin::Dir), ("ext.builtin.id", Builtin::Identity), ("ext.builtin.hash", Builtin::Hash), ("ext.builtin.input", Builtin::Input), ("ext.builtin.breakpoint", Builtin::Breakpoint), ("ext.builtin.help", Builtin::Help), ("ext.builtin.import", Builtin::Import), ("ext.builtin.sorted", Builtin::Sorted), 
        ...
        let mut lang = Lang {
            ...
            builtin_source_parameters: r.strings("ext.builtin.source.parameters")?,
            builtin_compile_parameters: r.strings("ext.builtin.compile.parameters")?,
            builtin_compile_modes: r.strings("ext.builtin.compile.modes")?,
            builtin_compile_kind: r.strings("ext.builtin.compile.kind")?,
            builtin_source_unready: r.strings("ext.builtin.source.unready")?,
            builtin_source_syntax: r.strings("ext.builtin.source.syntax")?,
            builtin_scope_unready: r.strings("ext.builtin.scope.unready")?,
            builtin_input_eof: r.strings("ext.builtin.input.eof")?,
            builtin_import_unready: r.strings("ext.builtin.import.unready")?,
            system_fault_class_name: r.strings("ext.system.fault.class.name")?,
            system_name_absent: r.strings("ext.system.name.absent")?,
            system_module_builtins: r.strings("ext.system.module.builtins")?,
            system_module_doc: r.strings("ext.system.module.doc")?,
            system_class_name: r.strings("ext.system.class.name")?,
            builtin_globals: r.strings("ext.builtin.globals")?,
            builtin_locals: r.strings("ext.builtin.locals")?,
            builtin_vars: r.strings("ext.builtin.vars")?,
            builtin_exec: r.strings("ext.builtin.exec")?,
            builtin_compile: r.strings("ext.builtin.compile")?,
            builtin_dir: r.strings("ext.builtin.dir")?,
            builtin_id: r.strings("ext.builtin.id")?,
            builtin_hash: r.strings("ext.builtin.hash")?,
            builtin_input: r.strings("ext.builtin.input")?,
            builtin_breakpoint: r.strings("ext.builtin.breakpoint")?,
            builtin_help: r.strings("ext.builtin.help")?,
            builtin_import: r.strings("ext.builtin.import")?,
            builtin_sorted: r.strings("ext.builtin.sorted")?,
