...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        let mut lang = Lang {
            ...
            class_details: ["property.doc", "property.readonly", "descriptor.get", "descriptor.set", "descriptor.delete", "descriptor.name", "property.fget", "property.fset", "property.fdel", "property.getter", "property.deleter", "descriptor.unready", "property.unreadable", "property.unwritable", "property.undeletable", "call", "locals", "root", "mro", "order", "name", "qualified", "bases", "namespace", "kind", "allocate", "subclass", "slots", "set", "remove", "get", "getitem", "doc", "module", "defaults", "code", "argcount", "varnames", "receiver", "function", "main", "mro.amiss", "attribute.amiss", "unready"].into_iter().map(|part| Ok((part.to_string(), r.strings(&format!("ext.stmt.class.detail.{}", part))?))).collect::<Result<_, String>>()?,
