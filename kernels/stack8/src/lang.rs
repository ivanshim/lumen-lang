...
pub struct Lang {
    pub compare_unsupported: Vec<String>,
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        let mut lang = Lang {
            ...
            compare_unsupported: r.strings("ext.op.compare.unsupported")?,
