...
pub struct Lang {
    ...
    pub type_params_unready: Vec<String>,
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        let mut lang = Lang {
            ...
            type_params_unready: r.strings("ext.stmt.type_params.unready")?,
