...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("ext.system.unicode.maximum", Builtin::UnicodeMaximum),
            ("ext.builtin.method.casefold", Builtin::ValueMethod),
            ("ext.builtin.method.swapcase", Builtin::ValueMethod),
            ("ext.builtin.method.isdecimal", Builtin::ValueMethod),
            ("ext.builtin.method.isnumeric", Builtin::ValueMethod),
            ("ext.builtin.method.isprintable", Builtin::ValueMethod),
            ("ext.builtin.method.isidentifier", Builtin::ValueMethod),
            ("ext.builtin.method.isascii", Builtin::ValueMethod),
            ("ext.builtin.method.expandtabs", Builtin::ValueMethod),
            ("ext.builtin.method.maketrans", Builtin::ValueMethod),
            ("ext.builtin.method.translate", Builtin::ValueMethod),
        ...
        let mut lang = Lang {
            ...
            text_options: r.strings("ext.system.text.options")?,
            text_errors: r.strings("ext.system.text.errors")?,
            unicode_text: r.flag("ext.system.text.unicode")?,
            chr_range: r.head("ext.builtin.chr.range")?.unwrap_or_default(),
