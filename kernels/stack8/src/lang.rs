...
pub struct Lang {
    ...
    pub index_amiss: Vec<String>,
    pub class_binary_amiss: Vec<String>,
    pub format_amiss: Vec<String>,
    pub class_root: Vec<String>,
...
const EXT_LABELS: &str = "w ext.stmt.class.root | w ext.stmt.class.index.amiss | w ext.stmt.class.binary.amiss | w ext.stmt.class.format.amiss | w ext.builtin.abs | w ext.builtin.bin | w ext.builtin.hex | w ext.builtin.oct | w ext.builtin.pow | w ext.builtin.divmod | w ext.builtin.format | w ext.builtin.round | w ext.builtin.reversed | w ext.builtin.sizeof | w ext.builtin.dir | w ext.builtin.complex | w ext.builtin.index | w ext.builtin.trunc | w ext.builtin.floor | w ext.builtin.ceil | w ext.stmt.class.special.unready | w ext.stmt.class.special.declined | w ext.stmt.class.special.stop | w ext.stmt.class.special | w ext.stmt.class.special.amiss | w ext.builtin.repr | w ext.builtin.hash | w ext.builtin.bool | w ext.builtin.sorted | w ext.builtin.iter | w ext.builtin.next | w ext.builtin.isinstance |
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("ext.builtin.bin", Builtin::BinaryText),
            ("ext.builtin.hex", Builtin::HexText),
            ("ext.builtin.oct", Builtin::OctalText),
            ("ext.builtin.pow", Builtin::PowerCall),
            ("ext.builtin.divmod", Builtin::DividePair),
            ("ext.builtin.format", Builtin::FormatCall),
            ("ext.builtin.round", Builtin::RoundCall),
            ("ext.builtin.reversed", Builtin::ReversedCall),
            ("ext.builtin.sizeof", Builtin::SizeCall),
            ("ext.builtin.dir", Builtin::DirCall),
            ("ext.builtin.complex", Builtin::ComplexCall),
            ("ext.builtin.index", Builtin::IndexCall),
            ("ext.builtin.trunc", Builtin::TruncCall),
            ("ext.builtin.floor", Builtin::FloorCall),
            ("ext.builtin.ceil", Builtin::CeilCall),
        ...
        let mut lang = Lang {
            ...
            index_amiss: r.strings("ext.stmt.class.index.amiss")?,
            class_binary_amiss: r.strings("ext.stmt.class.binary.amiss")?,
            format_amiss: r.strings("ext.stmt.class.format.amiss")?,
            class_root: r.strings("ext.stmt.class.root")?,
