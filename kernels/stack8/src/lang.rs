...
pub struct Lang {
    ...
    pub identity_warning: Vec<String>,
    pub reader_warning: Vec<String>,
    pub escape_warning: Vec<String>,
    pub octal_warning: Vec<String>,
    pub shared_list: Option<String>,
    pub shared_append: Option<String>,
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("builtin.precision", Builtin::Places), ("ext.builtin.iter", Builtin::Iter), ("ext.builtin.next", Builtin::Next), ("builtin.to_string", Builtin::ToText),
            ...
            ("ext.builtin.list.shared", Builtin::SharedList),
            ("ext.builtin.list.shared.append", Builtin::SharedAppend),
        ...
        let mut lang = Lang {
            ...
            identity_warning: r.strings("ext.op.identical.warning")?,
            reader_warning: r.strings("ext.system.warning.reader")?,
            escape_warning: r.strings("ext.lexical.escape.warning")?,
            octal_warning: r.strings("ext.lexical.escape.octal.warning")?,
            shared_list: r.head("ext.builtin.list.shared")?,
            shared_append: r.head("ext.builtin.list.shared.append")?,
