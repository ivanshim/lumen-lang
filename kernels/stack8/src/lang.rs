...
pub struct Lang {
    ...
    pub subclass_slots: Vec<String>,
    pub subclass_builtin: Vec<String>,
    pub subclass_layout: Vec<String>,
    pub subclass_allocate: Vec<String>,
    pub subclass_string: Vec<String>,
    pub subclass_equal: Vec<String>,
    pub subclass_item: Vec<String>,
    pub subclass_missing: Vec<String>,
    pub subclass_add: Vec<String>,
    pub subclass_dictionary: Vec<String>,
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        let mut lang = Lang {
            ...
            subclass_slots: r.strings("ext.stmt.class.slots")?,
            subclass_builtin: r.strings("ext.stmt.class.builtin")?,
            subclass_layout: r.strings("ext.stmt.class.layout")?,
            subclass_allocate: r.strings("ext.stmt.class.allocate")?,
            subclass_string: r.strings("ext.stmt.class.string")?,
            subclass_equal: r.strings("ext.stmt.class.equal")?,
            subclass_item: r.strings("ext.stmt.class.item")?,
            subclass_missing: r.strings("ext.stmt.class.missing")?,
            subclass_add: r.strings("ext.stmt.class.add")?,
            subclass_dictionary: r.strings("ext.stmt.class.dictionary")?,
