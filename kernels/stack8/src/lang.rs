...
pub struct Lang {
    pub identity_words: HashMap<String, Vec<String>>,
...
w ext.literal.unimplemented | w ext.builtin.object | w ext.builtin.hash.method | w ext.builtin.hash.result | w ext.builtin.bool.method | w ext.builtin.bool.result | w ext.builtin.bool.base | w ext.builtin.len.method | w ext.builtin.len.negative | w ext.op.eq.method | w ext.op.ne.method | w ext.op.order.unsupported
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        for (tag, native) in [
            ...
            ("ext.builtin.object", Builtin::Object),
        ...
        let mut lang = Lang {
            identity_words: ["ext.literal.unimplemented","ext.builtin.object","ext.builtin.hash.method","ext.builtin.hash.result","ext.builtin.bool.method","ext.builtin.bool.result","ext.builtin.bool.base","ext.builtin.len.method","ext.builtin.len.negative","ext.op.eq.method","ext.op.ne.method","ext.op.order.unsupported"].iter().map(|key| Ok((key.to_string(), r.strings(key)?))).collect::<Result<HashMap<_, _>, String>>()?,
            core_words,
            ident: name,
