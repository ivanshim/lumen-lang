...
w ext.builtin.complex | w ext.builtin.complex.real | w ext.builtin.complex.imag | w ext.builtin.method.conjugate | w ext.builtin.complex.invalid | w ext.builtin.complex.arguments | w ext.builtin.complex.integer | w ext.builtin.complex.order | w ext.builtin.complex.floor | w ext.builtin.complex.zero | w ext.builtin.complex.power.zero | w ext.builtin.complex.unready | 
...
impl Lang {
    pub fn parse(text: &str) -> Result<Lang, String> {
        ...
        let mut lang = Lang {
            ...
            complex_words: ["ext.builtin.complex", "ext.builtin.complex.real", "ext.builtin.complex.imag", "ext.builtin.method.conjugate", "ext.builtin.complex.invalid", "ext.builtin.complex.arguments", "ext.builtin.complex.integer", "ext.builtin.complex.order", "ext.builtin.complex.floor", "ext.builtin.complex.zero", "ext.builtin.complex.power.zero", "ext.builtin.complex.unready"].into_iter().map(|label| Ok((label.to_string(), r.strings(label)?))).collect::<Result<_, String>>()?,
