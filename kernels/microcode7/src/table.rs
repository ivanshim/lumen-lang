...
const EXT_TAGS: &str = "ext.stmt.class.special.unready:L ext.stmt.class.special.declined:L ext.stmt.class.special.stop:L ext.stmt.class.special:L ext.stmt.class.special.amiss:L ext.builtin.repr:L ext.builtin.hash:L ext.builtin.bool:L ext.builtin.sorted:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.isinstance:L \
