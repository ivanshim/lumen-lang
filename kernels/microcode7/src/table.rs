...
const EXT_TAGS: &str = "ext.stmt.class.detail.call:L ext.stmt.class.detail.root:L ext.stmt.class.detail.mro:L ext.stmt.class.detail.order:L ext.stmt.class.detail.name:L ext.stmt.class.detail.qualified:L ext.stmt.class.detail.bases:L ext.stmt.class.detail.namespace:L ext.stmt.class.detail.kind:L ext.stmt.class.detail.allocate:L ext.stmt.class.detail.subclass:L ext.stmt.class.detail.slots:L ext.stmt.class.detail.set:L ext.stmt.class.detail.remove:L ext.stmt.class.detail.get:L ext.stmt.class.detail.getitem:L ext.stmt.class.detail.doc:L ext.stmt.class.detail.module:L ext.stmt.class.detail.defaults:L ext.stmt.class.detail.code:L ext.stmt.class.detail.argcount:L ext.stmt.class.detail.varnames:L ext.stmt.class.detail.receiver:L ext.stmt.class.detail.function:L ext.stmt.class.detail.locals:L ext.stmt.class.detail.main:L ext.stmt.class.detail.mro.amiss:L ext.stmt.class.detail.attribute.amiss:L ext.stmt.class.detail.attribute.readonly:L ext.stmt.class.detail.unready:L ext.stmt.class.detail.descriptor.get:L ext.stmt.class.detail.descriptor.set:L ext.stmt.class.detail.descriptor.delete:L ext.stmt.class.detail.descriptor.name:L ext.stmt.class.detail.descriptor.foreign:L ext.stmt.class.detail.descriptor.unbound:L ext.stmt.class.detail.property.fget:L ext.stmt.class.detail.property.fset:L ext.stmt.class.detail.property.fdel:L ext.stmt.class.detail.property.getter:L ext.stmt.class.detail.property.deleter:L ext.stmt.class.detail.property.doc:L ext.stmt.class.detail.property.readonly:L ext.stmt.class.detail.property.unreadable:L ext.stmt.class.detail.property.unwritable:L ext.stmt.class.detail.property.undeletable:L ext.stmt.class.detail.namespace.amiss:L ext.stmt.class.detail.namespace.kept:L ext.stmt.class.detail.text.amiss:L ext.stmt.class.detail.globals:L ext.stmt.class.detail.closure:L ext.stmt.class.detail.keywords:L ext.stmt.class.detail.defaults.amiss:L ext.stmt.class.detail.keywords.amiss:L ext.stmt.class.detail.code.amiss:L ext.stmt.class.detail.code.free:L ext.stmt.class.detail.cell.contents:L ext.stmt.class.detail.cell.empty:L ext.stmt.class.detail.method.fixed:L ext.stmt.class.detail.kind.fixed:L ext.stmt.class.detail.kind.kept:L ext.stmt.class.detail.arguments.none:L ext.stmt.class.detail.arguments.init:L ext.stmt.class.detail.arguments.new:L ext.stmt.class.detail.root.members:L ext.builtin.issubclass:L ext.builtin.dir:L ext.builtin.staticmethod:L ext.builtin.classmethod:L ext.builtin.property:L ext.builtin.text.fault.protocol:L ext.op.index.text.negative:B ext.builtin.text.fault.index:L ext.builtin.text.splitlines:L ext.builtin.text.partition:L ext.builtin.text.rpartition:L ext.builtin.text.expandtabs:L ext.builtin.text.swapcase:L ext.builtin.text.casefold:L ext.builtin.text.capitalize:L ext.builtin.text.title:L ext.builtin.text.istitle:L ext.builtin.text.isidentifier:L ext.builtin.text.isprintable:L ext.builtin.text.isdecimal:L ext.builtin.text.isnumeric:L ext.builtin.text.isascii:L ext.builtin.text.removeprefix:L ext.builtin.text.removesuffix:L ext.builtin.text.format_map:L ext.builtin.text.maketrans:L ext.builtin.text.translate:L ext.builtin.text.encode:L ext.builtin.text.join:L ext.builtin.text.split:L ext.builtin.text.rsplit:L ext.builtin.text.strip:L ext.builtin.text.lstrip:L ext.builtin.text.rstrip:L ext.builtin.text.center:L ext.builtin.text.ljust:L ext.builtin.text.rjust:L ext.builtin.text.zfill:L ext.builtin.text.count:L ext.builtin.text.find:L ext.builtin.text.rfind:L ext.builtin.text.index:L ext.builtin.text.rindex:L ext.builtin.text.startswith:L ext.builtin.text.endswith:L ext.builtin.text.replace:L ext.builtin.text.upper:L ext.builtin.text.lower:L ext.builtin.text.length:L ext.builtin.text.repr:L ext.builtin.text.keyword.count:L ext.builtin.text.keyword.keepends:L ext.builtin.text.keyword.tabsize:L ext.builtin.text.keyword.maxsplit:L ext.builtin.text.keyword.sep:L ext.builtin.text.keyword.encoding:L ext.builtin.text.keyword.errors:L ext.builtin.text.fault.arguments:L ext.builtin.text.fault.arguments.many:L ext.builtin.text.fault.receiver:L ext.builtin.text.fault.string:L ext.builtin.text.fault.integer:L ext.builtin.text.fault.separator:L ext.builtin.text.fault.fill:L ext.builtin.text.fault.missing:L ext.builtin.text.fault.encode:L ext.builtin.text.fault.mapping:L ext.builtin.text.fault.translation:L ext.builtin.text.fault.codepoint:L ext.builtin.text.fault.surrogate:L ext.builtin.text.fault.maketrans.length:L ext.builtin.text.fault.maketrans.key:L ext.builtin.text.fault.maketrans.type:L ext.builtin.text.fault.format:L ext.builtin.text.fault.format.positional:L ext.builtin.text.fault.format.brace:L ext.builtin.text.fault.join:L ext.builtin.text.fault.walk:L ext.builtin.text.fault.room:L ext.builtin.text.fault.key:L ext.builtin.text.complaint:L ext.builtin.text.repeat:B ext.builtin.bytes.signed:L ext.system.bytes.strict:L ext.builtin.bytes:L ext.builtin.bytearray:L ext.builtin.bytes.encode:L ext.builtin.bytes.decode:L ext.builtin.bytes.hex:L ext.builtin.bytes.fromhex:L ext.builtin.bytearray.fromhex:L ext.builtin.bytes.maketrans:L ext.builtin.bytes.upper:L ext.builtin.bytes.lower:L ext.builtin.bytes.split:L ext.builtin.bytes.join:L ext.builtin.bytes.startswith:L ext.builtin.bytes.replace:L ext.builtin.bytes.strip:L ext.builtin.bytes.find:L ext.builtin.bytes.from_int:L ext.builtin.bytes.to_int:L ext.system.bytes.repr:L ext.system.bytes.type:L ext.system.bytes.encodings:L ext.system.bytes.order:L ext.system.bytes.unready:L ext.system.bytes.arguments:L ext.system.bytes.range:L ext.system.bytes.negative:L ext.system.bytes.index:L ext.system.bytes.subscript:L ext.system.bytes.concat:L ext.system.bytes.missing:L ext.system.bytes.immutable:L ext.system.bytes.unhashable:L ext.system.bytes.separator:L ext.system.bytes.hex:L ext.system.bytes.overflow:L ext.system.bytes.unsigned:L ext.system.bytes.bad_order:L ext.system.bytes.decode:L ext.system.bytes.encode:L ext.lexical.string.bytes.ascii:L ext.lexical.string.bytes.mixed:L ext.builtin.format:L ext.text.format:L ext.text.format.invalid:L ext.text.format.unknown:L ext.text.format.kinds:L ext.text.format.unready:L ext.text.format.digits:L ext.text.format.width.big:L ext.text.format.precision.big:L ext.text.format.precision.integer:L ext.text.format.precision.missing:L ext.text.format.sign.string:L ext.text.format.alternate.string:L ext.text.format.align.string:L ext.text.format.sign.character:L ext.text.format.alternate.character:L ext.text.format.character:L ext.text.format.spec.type:L ext.text.format.numbered.auto:L ext.text.format.numbered.manual:L ext.text.format.index:L ext.text.format.key:L ext.text.format.brace.open:L ext.text.format.brace.close:L ext.text.format.brace.single:L ext.text.format.conversion:L ext.text.format.recursion:L ext.op.rem.format.few:L ext.op.rem.format.many:L ext.op.rem.format.mapping:L ext.op.rem.format.number:L ext.op.rem.format.integer:L ext.op.rem.format.real:L ext.op.rem.format.character:L ext.op.rem.format.star:L ext.op.rem.format.incomplete:L ext.op.rem.format.code:L ext.lexical.number.point.open:B ext.op.rem.format.nan:L ext.op.rem.format.infinity:L ext.text.format.zero.integer:L ext.text.format.zero.string:L ext.lexical.string.long:L ext.op.lambda:L ext.op.tuple:L ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.stmt.class.builtin:L ext.stmt.class.layout:L ext.stmt.class.missing:L ext.stmt.del:L ext.stmt.nonlocal:L ext.stmt.nonlocal.unrun:L ext.stmt.with:L ext.stmt.with.as:L ext.stmt.yield:L ext.stmt.yield.from:L ext.stmt.yield.unrun:L ext.system.scope.unready:L ext.op.index.slice.ellipsis:L ext.op.index.slice:L ext.op.index.slice.zero:L ext.op.index.slice.bounds:L ext.op.index.slice.unsupported:L ext.op.index.slice.assign:L ext.op.index.slice.length:L ext.op.index.slice.detached:L ext.op.comprehension.async:L ext.op.comprehension.async.unavailable:L ext.op.comprehension.target.unavailable:L ext.builtin.sum.non_number:L ext.builtin.range.non_integer:L ext.builtin.range.zero_step:L ext.op.comprehension.for:L ext.op.comprehension.in:L ext.op.comprehension.if:L ext.syntax.set:B ext.syntax.array.spread:L ext.syntax.map.spread:L ext.syntax.collection.unwalkable:L ext.syntax.map.spread.unmapped:L ext.op.comprehension.unpack.amiss:L ext.builtin.range.value:B ext.builtin.sum:L ext.builtin.list:L ext.builtin.any:L ext.op.await:L ext.stmt.async:L ext.stmt.loop.else:B ext.stmt.del.unrun:L ext.stmt.binding.unrun:L ext.stmt.type_params.close:L ext.stmt.type_params.open:L ext.stmt.for.target.unready:L ext.op.identity.unready:L ext.op.identity.negated:L ext.op.identity:L ext.op.in.unready:L ext.op.in.negated:L ext.op.in:L ext.stmt.async.unready:L ext.stmt.with.unready:L ext.op.lambda.unready:L ext.op.member.pipes:B ext.op.tuple.unready:L ext.lexical.number.imaginary.unready:L ext.lexical.number.imaginary:L ext.lexical.number.point.bare:B ext.lexical.string.amiss:L ext.lexical.string.unterminated:L ext.lexical.string.unterminated.triple:L ext.lexical.string.prefix.format.unterminated:L ext.lexical.string.prefix.format.unterminated.triple:L ext.lexical.line_continuation.amiss:L ext.lexical.string.prefix.raw:L ext.lexical.string.prefix.plain:L ext.lexical.string.prefix.bytes:L ext.lexical.string.prefix.format:L ext.lexical.string.prefix.incompatible:L ext.lexical.string.adjacent:B ext.lexical.string.unready:L ext.lexical.line_continuation:L ext.op.bit.whole:B ext.lexical.escape.continued:B ext.stmt.with.unrun:L ext.stmt.async.unrun:L ext.op.contains:L ext.op.in.text:L ext.op.in.uncontained:L ext.op.in.declined:L ext.op.bit.or.maps:B ext.op.eq.maps.unordered:B ext.builtin.print.separator:L ext.builtin.print.end:L ext.builtin.print.option.type:L ext.builtin.map:L ext.builtin.map.arguments.amiss:L ext.builtin.map.pair.amiss:L ext.stmt.yield.suspends:B ext.stmt.yield.exhausted:L ext.stmt.yield.send:L ext.stmt.yield.close:L ext.stmt.yield.throw:L ext.stmt.yield.running:L ext.stmt.yield.unstarted:L ext.stmt.yield.busy:L ext.stmt.yield.unsupported:L ext.stmt.yield.throw.invalid:L ext.stmt.yield.exit:L ext.stmt.yield.close.ignored:L ext.builtin.next:L ext.builtin.iter:L ext.builtin.tuple:L ext.builtin.method.sort.key:L ext.builtin.method.sort.reverse:L ext.builtin.method.sort.modified:L ext.builtin.method.split.sep:L ext.builtin.method.split.maxsplit:L ext.builtin.method.upper:L ext.builtin.method.lower:L ext.builtin.method.strip:L ext.builtin.method.lstrip:L ext.builtin.method.rstrip:L ext.builtin.method.split:L ext.builtin.method.rsplit:L ext.builtin.method.join:L ext.builtin.method.replace:L ext.builtin.method.startswith:L ext.builtin.method.endswith:L ext.builtin.method.find:L ext.builtin.method.rfind:L ext.builtin.method.rindex:L ext.builtin.method.index:L ext.builtin.method.count:L ext.builtin.method.isdigit:L ext.builtin.method.isalpha:L ext.builtin.method.isalnum:L ext.builtin.method.isspace:L ext.builtin.method.islower:L ext.builtin.method.isupper:L ext.builtin.method.title:L ext.builtin.method.capitalize:L ext.builtin.method.swapcase:L ext.builtin.method.center:L ext.builtin.method.ljust:L ext.builtin.method.rjust:L ext.builtin.method.zfill:L ext.builtin.method.format:L ext.builtin.method.encode:L ext.builtin.method.append:L ext.builtin.method.extend:L ext.builtin.method.insert:L ext.builtin.method.pop:L ext.builtin.method.remove:L ext.builtin.method.sort:L ext.builtin.method.reverse:L ext.builtin.method.copy:L ext.builtin.method.clear:L ext.builtin.method.get:L ext.builtin.method.keys:L ext.builtin.method.values:L ext.builtin.method.items:L ext.builtin.method.mapping:L ext.builtin.method.setdefault:L ext.builtin.method.update:L ext.builtin.method.bit_length:L ext.builtin.method.is_integer:L ext.builtin.method.hex:L ext.builtin.method.as_integer_ratio:L ext.builtin.method.error.unready:L ext.builtin.method.error.bytes:L ext.builtin.method.error.arguments:L ext.builtin.method.error.separator:L ext.builtin.method.error.substring:L ext.builtin.method.error.pop:L ext.builtin.method.error.index:L ext.builtin.method.error.remove:L ext.builtin.method.error.list_index:L ext.builtin.method.error.format:L ext.builtin.method.error.spec:L ext.builtin.method.error.unicode:L ext.builtin.method.error.attribute:L ext.builtin.method.error.key:L ext.builtin.method.error.missing:L ext.builtin.method.error.mixed:L ext.builtin.method.error.fill:L ext.builtin.method.error.hex:L ext.builtin.method.error.hex_overflow:L ext.builtin.sorted:L ext.stmt.class.suite:L ext.stmt.class.suite.unsupported:L ext.stmt.with.group.open:L ext.stmt.with.group.close:L ext.stmt.with.unsupported:L ext.stmt.nonlocal.unsupported:L ext.stmt.delete:L ext.stmt.delete.unsupported:L ext.syntax.tuple.separator:L ext.syntax.tuple.unsupported:L ext.syntax.value.spread:L ext.syntax.value.spread.unsupported:L ext.op.index.spread.unsupported:L ext.op.conditional:L ext.stmt.function.short.bare:B ext.lexical.string.triple:B ext.lexical.string.raw_prefix:L ext.lexical.string.text_prefix:L ext.syntax.string.adjacent:B ext.op.identity.unsupported:L ext.op.comparison.chain:B ext.stmt.for.range.stop:B ext.builtin.isinstance:L ext.builtin.set:L ext.builtin.dict:L ext.builtin.reversed:L ext.builtin.enumerate:L ext.builtin.iterable:L ext.builtin.enumerate.missing:L ext.builtin.enumerate.too_many:L ext.builtin.enumerate.keyword:L ext.builtin.reduce_native:L ext.builtin.rebuild_native:L ext.builtin.zip:L ext.builtin.filter:L ext.builtin.all:L ext.builtin.min:L ext.builtin.max:L ext.builtin.abs:L ext.builtin.round:L ext.builtin.divmod:L ext.builtin.pow:L ext.builtin.hex:L ext.builtin.oct:L ext.builtin.bin:L ext.builtin.repr:L ext.builtin.bool:L ext.builtin.callable:L ext.builtin.id:L ext.builtin.hash:L ext.builtin.hasattr:L ext.builtin.getattr:L ext.builtin.setattr:L ext.builtin.delattr:L ext.builtin.vars:L ext.builtin.key:L ext.builtin.reverse:L ext.builtin.start:L ext.builtin.default:L ext.builtin.round.ndigits:L ext.builtin.round.number:L ext.builtin.pow.base:L ext.builtin.pow.exp:L ext.builtin.pow.mod:L ext.builtin.core.uniterable:L ext.builtin.core.unreversible:L ext.builtin.core.uncallable:L ext.builtin.core.unhashable:L ext.builtin.core.unready:L ext.builtin.core.exhausted:L ext.builtin.core.isinstance.amiss:L ext.builtin.core.issubclass.amiss:L ext.builtin.core.issubclass.subject:L ext.builtin.core.empty:L ext.builtin.core.arity:L ext.builtin.core.attribute:L ext.builtin.core.attribute.name:L ext.builtin.core.vars:L ext.builtin.core.zero:L ext.builtin.core.mod.zero:L ext.builtin.core.inverse:L ext.builtin.core.default.many:L ext.builtin.core.dict.pair:L ext.builtin.core.unindexable:L ext.builtin.core.immutable:L ext.builtin.core.power.zero:L ext.builtin.core.power.overflow:L ext.builtin.core.arity.one:L ext.builtin.core.arity.exact:L ext.builtin.core.integer:L ext.builtin.core.not_iterator:L ext.builtin.core.power.integer:L ext.builtin.core.dict.sequence:L ext.builtin.set.add:L ext.builtin.set.remove:L ext.builtin.set.discard:L ext.builtin.set.pop:L ext.builtin.set.clear:L ext.builtin.set.copy:L ext.builtin.set.update:L ext.builtin.set.union:L ext.builtin.set.intersection:L ext.builtin.set.difference:L ext.builtin.set.symmetric_difference:L ext.builtin.set.issubset:L ext.builtin.set.issuperset:L ext.builtin.set.isdisjoint:L ext.builtin.set.intersection_update:L ext.builtin.set.difference_update:L ext.builtin.set.symmetric_difference_update:L ext.builtin.set.sorted:L ext.builtin.set.method.unavailable:L ext.builtin.set.changed:L ext.builtin.set.unhashable:L ext.builtin.set.missing:L ext.builtin.set.empty:L ext.builtin.set.operands:L ext.builtin.set.arguments:L ext.builtin.set.unsupported:L ext.builtin.set.unsortable:L ext.stmt.class.special.unready:L ext.stmt.class.special.declined:L ext.stmt.class.special.stop:L ext.stmt.class.special:L ext.stmt.class.special.amiss:L ext.op.arithmetic.binary:B ext.op.arithmetic.flags:B ext.op.arithmetic.strict:B ext.builtin.to_real.nan:L ext.builtin.to_real.infinity:L ext.lexical.number.point_open:B ext.op.pow.real_exponent:B ext.op.pow.overflow:L ext.op.pow.nonreal:L ext.op.pow.zero:L ext.op.div.zero:L ext.op.quot.zero:L ext.op.quot.real_zero:L ext.op.rem.real_zero:L ext.builtin.to_int.text.detail:L ext.op.bit.unbounded:B ext.op.bit.integer:L ext.op.bit.beyond:L \
...
ext.op.if_else:L ext.op.lambda.unsupported:L ext.op.lambda.enclosing:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.op.in:L ext.op.in.negated:L ext.op.in.unsupported:L ext.op.compare.chained:B ext.op.assign.expression:L ext.literal.ellipsis:L ext.literal.unimplemented:L ext.syntax.names.shadow_builtins:B ext.builtin.method.bit_count:L ext.builtin.method.numerator:L ext.builtin.method.denominator:L ext.builtin.method.real:L ext.builtin.method.imag:L ext.builtin.method.__index__:L ext.builtin.method.__truediv__:L ext.builtin.method.fromhex:L ext.builtin.to_int.digits:N ext.builtin.to_int.digits.state:L ext.builtin.to_int.digits.amiss:L ext.builtin.to_int.infinity:L ext.builtin.to_int.nan:L ext.builtin.round.whole.even:B ext.builtin.bool.base:L ext.builtin.bool.result:L ext.op.order.unsupported:L ext.op.rem.formats_text:B ext.op.rem.format.unsupported:L ext.op.rem.format.arguments:L ext.lexical.number.exponent:L ext.op.plus:L ext.stmt.break.levels:B ext.builtin.array:L ext.op.index.append:B ext.stmt.for.collection:B ext.builtin.print_r:L ext.stmt.terminator:L ext.stmt.annotation:L ext.stmt.annotation.amiss:L ext.stmt.annotation.target.unready:L ext.stmt.function.returns:L ext.stmt.class:L ext.stmt.class.extends:L ext.stmt.class.new:L ext.stmt.class.this:L ext.stmt.class.this.explicit:B ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.op.member.pipes:B ext.stmt.class.unready:L ext.lexical.line_continuation:L ext.lexical.number.point.bare:B ext.lexical.number.separator.after_prefix:B ext.op.bit.whole:B ext.builtin.print.real_point:B ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unready:L ext.lexical.number.point_edge:B ext.lexical.number.separator.strict:B ext.lexical.number.amiss.leading_zero:L ext.lexical.number.amiss.binary:L ext.lexical.number.amiss.binary.digit:L ext.lexical.number.amiss.octal:L ext.lexical.number.amiss.octal.digit:L ext.lexical.number.amiss.hex:L ext.stmt.assign.names.chained:B ext.syntax.call.chained:B ext.op.lambda:L ext.op.lambda.unready:L ext.literal.ellipsis.unready:L ext.stmt.with:L ext.stmt.with.as:L ext.stmt.with.unready:L ext.op.tuple:L ext.op.tuple.unready:L ext.op.matrix:L ext.op.matrix.unready:L ext.stmt.loop.else:B ext.lexical.string.adjacent:B ext.lexical.string.prefix.bytes:L ext.lexical.string.bytes.unready:L ext.lexical.number.imaginary.unrun:L ext.op.await:L ext.stmt.async:L ext.stmt.match:L ext.stmt.match.case:L ext.stmt.type_alias:L ext.stmt.type_parameters:B ext.op.pipe.attribute:B ext.stmt.class.constructor:L ext.stmt.class.modifier:L ext.stmt.class.hidden:L ext.stmt.class.guarded:L ext.stmt.class.shared:L ext.op.member:L ext.op.scope:L ext.stmt.class.static:L ext.stmt.class.classmethod:L ext.stmt.class.property:L ext.stmt.class.property.setter:L \
...
ext.stmt.function.carries.pairs:L ext.stmt.function.keyword_only:L ext.stmt.function.positional_only:L ext.syntax.call.bind_names:B ext.syntax.call.spread:L ext.syntax.call.spread.pairs:L ext.syntax.call.amiss:L ext.syntax.call.amiss.missing:L ext.syntax.call.amiss.positional:L ext.syntax.call.amiss.unknown:L ext.syntax.call.amiss.duplicate:L ext.syntax.call.amiss.builtin:L ext.syntax.call.amiss.keyword:L ext.syntax.call.amiss.repeated:L ext.syntax.call.amiss.absent:L ext.syntax.call.amiss.absent.names:L ext.syntax.call.amiss.excess:L ext.syntax.call.amiss.unexpected:L ext.syntax.call.amiss.ordered:L ext.syntax.call.amiss.order:L ext.builtin.print.sep:L ext.builtin.print.end:L ext.builtin.print.file:L ext.builtin.print.flush:L ext.builtin.print.file.error:L ext.builtin.print.file.output:L ext.builtin.print.file.unready:L ext.builtin.print.sep.amiss:L ext.builtin.print.end.amiss:L ext.builtin.to_int.base:L ext.builtin.to_int.base.amiss:L ext.builtin.to_int.text.amiss:L ext.builtin.to_int.text.required:L ext.builtin.to_real.text:B ext.builtin.to_real.text.amiss:L ext.builtin.to_string.object:L ext.builtin.to_string.encoding:L ext.builtin.to_string.errors:L ext.builtin.to_string.undecodable:L ext.builtin.to_string.unready:L ext.builtin.range.value:B ext.builtin.range.zero:L ext.builtin.range.integer:L ext.builtin.range.index:L ext.builtin.range.members:L ext.builtin.range.missing:L ext.syntax.call.spread.amiss:L ext.syntax.call.spread.pairs.amiss:L ext.stmt.function.defaults.amiss:L ext.stmt.function.parameters.amiss:L ext.stmt.function.parameters.duplicate:L ext.stmt.function.carries:L ext.stmt.function.short:L ext.stmt.function.anonymous:L ext.stmt.class.trait:L ext.stmt.class.uses:L ext.stmt.class.uses.alias:L ext.stmt.class.interface:L ext.stmt.class.implements:L ext.op.compare:L ext.builtin.unset:L ext.lexical.template:B ext.lexical.prologue.echo:L ext.lexical.prologue.folded:B ext.lexical.line_continuation:L ext.lexical.number.separator.after_prefix:B ext.op.bit.whole:B ext.op.bit.whole.room:L ext.op.plus.non_number:L ext.stmt.function.async:L ext.stmt.function.async.unavailable:L ext.op.bit.whole.amiss:L ext.op.bit.whole.large:L ext.op.matrix:L ext.op.matrix.unavailable:L ext.op.otherwise:L ext.op.bit.and:L ext.op.bit.or:L ext.op.bit.xor:L ext.op.bit.not:L ext.op.bit.left.unready:L ext.op.bit.left:L ext.op.bit.right:L ext.op.bit.shift.numbers:B ext.op.identical:L ext.op.not_identical:L ext.system.kind.spelled:B ext.builtin.args.all:L ext.builtin.args.count:L ext.builtin.args.at:L ext.builtin.args.all.outside:L ext.builtin.args.count.outside:L ext.builtin.args.at.outside:L ext.builtin.args.at.below:L ext.builtin.args.at.beyond:L ext.op.assign.value:B ext.op.index.plain_keys:B ext.stmt.assign.chain:B ext.op.matrix.unready:L ext.op.bit.operands:L \
ext.system.runner:L ext.system.source.file:L ext.system.source.directory:L ext.system.source.line:L ext.system.source.routine:L ext.system.source.class:L ext.system.source.method:L ext.system.debug:L \
...
ext.builtin.file.exists:L ext.builtin.file.kind:L ext.builtin.host.info:L ext.builtin.file.remove:L ext.builtin.dir.list:L ext.builtin.dir.make:L ext.builtin.dir.remove_tree:L ext.builtin.eval:L ext.builtin.include:L ext.builtin.include.once:L ext.builtin.print.redirect:L ext.builtin.input:L ext.builtin.input.reader:L ext.builtin.stream.write:L ext.builtin.stream.read:L ext.builtin.stream.amiss:L ext.builtin.stream.failed:L ext.builtin.output.hold:L ext.builtin.output.held:L ext.builtin.output.drop:L ext.builtin.output.depth:L ext.builtin.output.begun:L ext.builtin.at_end:L ext.builtin.complaint.handler:L ext.builtin.complaint.say:L ext.builtin.calls:L ext.system.kind.object:L ext.system.kind.loose:L ext.builtin.uncaught:L ext.builtin.classes:L ext.builtin.routines:L ext.builtin.spelled:L ext.builtin.class.beneath:L ext.builtin.math:L ext.builtin.class.methods:L ext.builtin.class.properties:L ext.builtin.clock:L ext.builtin.clock.parts:B ext.builtin.room.used:L ext.builtin.room.most:L ext.builtin.room.most.forget:L ext.builtin.room.limit:L ext.builtin.write.operator:B ext.op.hush:L ext.op.name_by_value:L ext.op.cast:B ext.op.member.by_value:B ext.op.index.text:B ext.op.index.text.first:L ext.system.globals:L ext.op.reference.unshared.written:L ext.op.reference.unshared.given:L ext.op.reference.unshared.handed:L ext.stmt.terminator.only:B ext.stmt.block.instead:L ext.stmt.block.instead.close:L ext.op.spelled:B ext.system.class.folded:B ext.stmt.unpack:L ext.builtin.isset:L ext.builtin.empty:L ext.stmt.do:L ext.op.index.makes:B ext.system.untrue.text:L ext.system.untrue.empty_array:B ext.builtin.exit:L ext.lexical.string.long:L ext.lexical.string.prefix.raw:L ext.lexical.string.prefix.bytes:L ext.lexical.string.prefix.plain:L ext.lexical.string.prefix.format:L ext.lexical.string.prefix.incompatible:L ext.lexical.string.adjacent:B ext.lexical.string.amiss:L ext.lexical.escape.byte.digits:N ext.lexical.escape.codepoint.digits:N ext.lexical.escape.codepoint.wide:L ext.lexical.escape.codepoint.wide.digits:N ext.lexical.escape.named:L ext.lexical.escape.unavailable:L ext.lexical.escape.continued:B ext.lexical.escape.controls:L ext.lexical.escape.codepoint:L ext.lexical.escape.codepoint.open:L ext.lexical.escape.codepoint.close:L ext.lexical.escape.codepoint.amiss:L ext.lexical.escape.codepoint.beyond:L ext.lexical.number.amiss:L ext.stmt.separator:L ext.op.tuple:L ext.stmt.unpack.rest:L ext.stmt.assign.chain:B ext.stmt.unpack.short:L ext.stmt.unpack.long:L ext.stmt.unpack.unwalkable:L ext.stmt.unpack.amiss:L ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.op.member.pipes:B ext.stmt.with:L ext.stmt.with.as:L ext.stmt.with.unready:L ext.op.tuple.unready:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.builtin.range.zero_start:B ext.lexical.string.value.unready:L ext.lexical.line_continuation:L ext.lexical.string.bytes.unavailable:L ext.lexical.string.format.errors:L ext.lexical.string.format.unavailable:L ext.lexical.string.unready:L ext.builtin.exceptions:L ext.builtin.exceptions.args:L ext.builtin.exceptions.cause:L ext.builtin.class.name:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.repr:L ext.system.fault.class.index:L ext.system.fault.class.key:L ext.system.source.marked:B ext.system.fault.current:L ext.system.module.getattr:L ext.stmt.class.annotations:L ext.stmt.class.called:L ext.op.order.text:B ext.op.logical.operand:B ext.builtin.slice:L ext.builtin.slice.start:L ext.builtin.slice.stop:L ext.builtin.slice.step:L ext.builtin.slice.arity:L ext.builtin.slice.length:L ext.op.index.integer:L ext.op.index.slice.amiss:L ext.builtin.method.indices:L ext.builtin.method.slice_hash:L ext.stmt.class.walked:L ext.system.fault.class.name:L ext.system.fault.class.attribute:L ext.system.fault.class.stop:L ext.system.fault.division:L ext.system.fault.index:L ext.system.fault.index.assign:L ext.system.fault.name:L ext.system.fault.attribute:L ext.system.fault.kind:L ext.builtin.exceptions.unready:L ext.builtin.exceptions.context:L ext.builtin.exceptions.suppress:L ext.builtin.exceptions.traceback:L ext.stmt.throw.invalid:L ext.stmt.with.invalid:L ext.system.recursion.limit:N ext.system.recursion.exceeded:L ext.builtin.exceptions.note:L ext.builtin.exceptions.notes:L ext.builtin.exceptions.note.invalid:L ext.builtin.exceptions.traceback.member:L ext.builtin.exceptions.traceback.with:L ext.builtin.exceptions.name:L ext.builtin.exceptions.object:L ext.builtin.exceptions.value:L ext.builtin.exceptions.os:L ext.builtin.exceptions.os.message:L ext.builtin.exceptions.unicode:L ext.builtin.exceptions.group.message:L ext.builtin.exceptions.group.members:L ext.builtin.exceptions.group.split:L ext.builtin.exceptions.group.subgroup:L ext.builtin.exceptions.group.derive:L ext.builtin.exceptions.group.summary:L ext.builtin.exceptions.group.invalid:L ext.system.fault.held:L ext.stmt.catch.amiss:L ext.stmt.yield.escaped:L ext.builtin.exceptions.syntax:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 281] = [
            ...
            ("ext.builtin.method.rindex", Prim::ValueMethod),
            ...
            ("ext.builtin.method.swapcase", Prim::ValueMethod),
            ...
            ("ext.builtin.method.mapping", Prim::ValueMethod),
...
impl Table {
    ...
    pub fn begins_name(&self, c: char) -> bool {
        if self.has_any("ext.builtin.exceptions.syntax") { return c == '_' || crate::unicode::property(c, 4); }
    ...
    pub fn extends_name(&self, c: char) -> bool {
        if self.has_any("ext.builtin.exceptions.syntax") { return crate::unicode::property(c, 8); }
        let a_byte = self.flag("ext.system.text.bytes");
        let far = a_byte && self.flag("identifier.unicode") && c >= '\u{80}';
        if a_byte {
