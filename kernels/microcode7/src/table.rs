...
pub const BUILTIN_LABELS: [(&str, Prim); 75] = [
    ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.next", Prim::Following), ("ext.builtin.iter", Prim::Iterator), ("ext.builtin.tuple", Prim::Tupled), ("ext.builtin.any", Prim::SomeTrue),
