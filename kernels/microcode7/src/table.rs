...
ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unready:L ext.lexical.number.point_edge:B ext.lexical.number.separator.strict:B ext.lexical.number.amiss.leading_zero:L ext.lexical.number.amiss.binary:L ext.lexical.number.amiss.binary.digit:L ext.lexical.number.amiss.octal:L ext.lexical.number.amiss.octal.digit:L ext.lexical.number.amiss.hex:L ext.system.real.shortest:B \
