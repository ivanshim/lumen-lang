...
ext.lexical.number.point.bare:B ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unready:L ext.lexical.number.exponent:L ext.op.plus:L ext.stmt.break.levels:B ext.builtin.array:L ext.op.index.append:B ext.stmt.for.collection:B ext.builtin.print_r:L \
