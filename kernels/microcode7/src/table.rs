...
ext.builtin.bytes.signed:L ext.system.bytes.strict:L ext.system.bytes.repr:L ext.system.bytes.type:L ext.system.bytes.encodings:L ext.system.bytes.order:L ext.system.bytes.unready:L ext.system.bytes.arguments:L ext.system.bytes.range:L ext.system.bytes.negative:L ext.system.bytes.index:L ext.system.bytes.immutable:L ext.system.bytes.unhashable:L ext.system.bytes.separator:L ext.system.bytes.hex:L ext.system.bytes.overflow:L ext.system.bytes.unsigned:L ext.system.bytes.bad_order:L ext.system.bytes.decode:L ext.system.bytes.encode:L ext.lexical.string.bytes.ascii:L ext.lexical.string.bytes.mixed:L const EXT_TAGS: &str = "\
