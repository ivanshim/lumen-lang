...
ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.op.member.pipes:B ext.stmt.with:L ext.stmt.with.as:L ext.stmt.with.unready:L ext.op.tuple:L ext.op.tuple.unready:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.builtin.range.zero_start:B ext.lexical.string.value.unready:L ext.lexical.string.long:L ext.lexical.string.prefix.raw:L ext.lexical.string.prefix.bytes:L ext.lexical.string.prefix.plain:L ext.lexical.string.prefix.format:L ext.lexical.string.adjacent:B ext.lexical.string.amiss:L ext.lexical.escape.byte.digits:N ext.lexical.escape.codepoint.digits:N ext.lexical.escape.codepoint.wide:L ext.lexical.escape.codepoint.wide.digits:N ext.lexical.escape.named:L ext.lexical.escape.unavailable:L \
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        if self.has_any("ext.stmt.class") && !self.has_any("ext.stmt.class.bases.open") && (!self.has_any("ext.op.member") || !self.has_any("ext.stmt.class.new")) {
        ...
        let symbol_labels = ["ext.stmt.class.bases.open", "ext.stmt.class.bases.close", "ext.stmt.with", "ext.stmt.with.as", "ext.op.tuple", "ext.op.identical.negated", "ext.lexical.string.long", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close",
