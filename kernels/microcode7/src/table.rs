...
ext.op.bit.left.unready:L ext.op.bit.left:L ext.op.bit.right:L ext.op.bit.shift.numbers:B ext.op.identical:L ext.op.not_identical:L ext.system.kind.spelled:B ext.builtin.args.all:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 78] = [
    ("ext.builtin.map", Prim::Dictionary), ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.any", Prim::SomeTrue),
    ("ext.builtin.iter", Prim::Iterate), ("ext.builtin.next", Prim::NextOne),
