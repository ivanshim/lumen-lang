...
const EXT_TAGS: &str = "ext.stmt.class.root:L ext.stmt.class.index.amiss:L ext.stmt.class.binary.amiss:L ext.stmt.class.format.amiss:L ext.builtin.abs:L ext.builtin.bin:L ext.builtin.hex:L ext.builtin.oct:L ext.builtin.pow:L ext.builtin.divmod:L ext.builtin.format:L ext.builtin.round:L ext.builtin.reversed:L ext.builtin.sizeof:L ext.builtin.dir:L ext.builtin.complex:L ext.builtin.index:L ext.builtin.trunc:L ext.builtin.floor:L ext.builtin.ceil:L ext.stmt.class.special.unready:L ext.stmt.class.special.declined:L ext.stmt.class.special.stop:L ext.stmt.class.special:L ext.stmt.class.special.amiss:L ext.builtin.repr:L ext.builtin.hash:L ext.builtin.bool:L ext.builtin.sorted:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.isinstance:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 96] = [
    ("ext.builtin.map", Prim::Dictionary), ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.any", Prim::SomeTrue),
    ("ext.builtin.abs", Prim::Absolute),
    ("ext.builtin.bin", Prim::BinaryText),
    ("ext.builtin.hex", Prim::HexText),
    ("ext.builtin.oct", Prim::OctalText),
    ("ext.builtin.pow", Prim::PowerCall),
    ("ext.builtin.divmod", Prim::DividePair),
    ("ext.builtin.format", Prim::FormatCall),
    ("ext.builtin.round", Prim::RoundCall),
    ("ext.builtin.reversed", Prim::ReversedCall),
    ("ext.builtin.sizeof", Prim::SizeCall),
    ("ext.builtin.dir", Prim::DirCall),
    ("ext.builtin.complex", Prim::ComplexCall),
    ("ext.builtin.index", Prim::IndexCall),
    ("ext.builtin.trunc", Prim::TruncCall),
    ("ext.builtin.floor", Prim::FloorCall),
    ("ext.builtin.ceil", Prim::CeilCall),
    ("ext.builtin.repr", Prim::SpecialRepr),
    ("ext.builtin.hash", Prim::SpecialHash),
    ("ext.builtin.bool", Prim::SpecialBool),
    ("ext.builtin.sorted", Prim::SpecialSorted),
    ("ext.builtin.iter", Prim::SpecialIter),
    ("ext.builtin.next", Prim::SpecialNext),
    ("ext.builtin.isinstance", Prim::SpecialIsInstance),
