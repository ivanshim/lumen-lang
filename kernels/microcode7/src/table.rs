...
ext.builtin.file.exists:L ext.builtin.file.remove:L ext.builtin.eval:L ext.builtin.include:L ext.builtin.include.once:L ext.builtin.print.redirect:L ext.builtin.input:L ext.builtin.input.reader:L ext.builtin.stream.write:L ext.builtin.stream.read:L ext.builtin.stream.amiss:L ext.builtin.stream.failed:L ext.builtin.output.hold:L ext.builtin.output.held:L ext.builtin.output.drop:L ext.builtin.output.depth:L ext.builtin.output.begun:L ext.builtin.at_end:L ext.builtin.complaint.handler:L ext.builtin.complaint.say:L ext.builtin.calls:L ext.system.kind.object:L ext.system.kind.loose:L ext.builtin.uncaught:L ext.builtin.classes:L ext.builtin.routines:L ext.builtin.spelled:L ext.builtin.class.beneath:L ext.builtin.math:L ext.builtin.class.methods:L ext.builtin.class.properties:L ext.builtin.clock:L ext.builtin.room.used:L ext.builtin.room.most:L ext.builtin.room.most.forget:L ext.builtin.room.limit:L ext.builtin.write.operator:B ext.op.hush:L ext.op.name_by_value:L ext.op.cast:B ext.op.member.by_value:B ext.op.index.text:B ext.op.index.text.first:L ext.system.globals:L ext.op.reference.unshared.written:L ext.op.reference.unshared.given:L ext.op.reference.unshared.handed:L ext.stmt.terminator.only:B ext.stmt.block.instead:L ext.stmt.block.instead.close:L ext.op.spelled:B ext.system.class.folded:B ext.stmt.unpack:L ext.builtin.isset:L ext.builtin.empty:L ext.stmt.do:L ext.op.index.makes:B ext.system.untrue.text:L ext.system.untrue.empty_array:B ext.builtin.exit:L ext.lexical.string.long:L ext.lexical.string.prefix.raw:L ext.lexical.string.prefix.bytes:L ext.lexical.string.prefix.plain:L ext.lexical.string.prefix.format:L ext.lexical.string.adjacent:B ext.lexical.string.amiss:L ext.lexical.escape.byte.digits:N ext.lexical.escape.codepoint.digits:N ext.lexical.escape.codepoint.wide:L ext.lexical.escape.codepoint.wide.digits:N ext.lexical.escape.named:L ext.lexical.escape.unavailable:L ext.lexical.escape.continued:B ext.lexical.escape.controls:L ext.lexical.escape.codepoint:L ext.lexical.escape.codepoint.open:L ext.lexical.escape.codepoint.close:L ext.lexical.escape.codepoint.amiss:L ext.lexical.escape.codepoint.beyond:L ext.lexical.number.amiss:L ext.stmt.separator:L ext.op.tuple:L ext.stmt.unpack.rest:L ext.stmt.assign.chain:B ext.stmt.unpack.short:L ext.stmt.unpack.long:L ext.stmt.unpack.unwalkable:L ext.stmt.unpack.amiss:L ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.op.member.pipes:B ext.stmt.with:L ext.stmt.with.as:L ext.stmt.with.unready:L ext.op.tuple.unready:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.builtin.range.zero_start:B ext.lexical.string.value.unready:L ext.lexical.line_continuation:L ext.lexical.string.bytes.unavailable:L ext.lexical.string.format.unavailable:L ext.lexical.string.unready:L ext.builtin.exceptions:L ext.builtin.exceptions.args:L ext.builtin.exceptions.cause:L ext.builtin.class.name:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.repr:L ext.system.fault.class.index:L ext.system.fault.class.key:L ext.system.fault.class.name:L ext.system.fault.class.attribute:L ext.system.fault.class.stop:L ext.system.fault.division:L ext.system.fault.index:L ext.system.fault.name:L ext.system.fault.attribute:L ext.system.fault.kind:L ext.builtin.exceptions.unready:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 245] = [
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        for (label, op) in BUILTIN_LABELS {
            if op == Prim::ValueMethod { continue; }
            for lex in self.strings(label).to_vec() {
