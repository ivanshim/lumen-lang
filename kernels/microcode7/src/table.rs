...
ext.op.lambda:L ext.op.lambda.unsupported:L ext.op.lambda.enclosing:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.op.in:L ext.op.in.negated:L ext.op.in.unsupported:L ext.op.compare.chained:B \
ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unrun:L \
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.lexical.line_continuation", "ext.lexical.string.long", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "ext.op.comprehension.async", "ext.op.comprehension.for", "ext.op.comprehension.in", "ext.op.comprehension.if", "ext.syntax.array.spread", "ext.syntax.map.spread", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close", "ext.op.lambda", "ext.op.identical.negated", "ext.op.in.negated",
            ...
            "ext.stmt.throw", "ext.stmt.catch.separator", "ext.op.reference", "ext.op.otherwise", "ext.op.hush", "ext.op.name_by_value", "ext.stmt.unpack", "ext.op.tuple", "ext.stmt.unpack.rest"];
