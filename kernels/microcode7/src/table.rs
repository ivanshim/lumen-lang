...
pub const BUILTIN_LABELS: [(&str, Prim); 156] = [
            ...
            ("ext.builtin.method.indices", Prim::ValueMethod), ("ext.builtin.method.slice_hash", Prim::ValueMethod), ("ext.builtin.method.upper", Prim::ValueMethod),
    ...
    ("builtin.error", Prim::Raise), ("builtin.extern", Prim::External), ("ext.builtin.itemgetter", Prim::GatherKeys), ("ext.builtin.slice", Prim::SliceValue), ("builtin.range", Prim::Span), ("builtin.real", Prim::MakeReal),
