...
ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unready:L ext.op.await:L ext.stmt.async:L ext.stmt.match:L ext.stmt.match.case:L ext.stmt.type_alias:L ext.stmt.type_parameters:B ext.op.bit.whole:B ext.op.pipe.attribute:B ext.lexical.number.exponent:L ext.op.plus:L ext.stmt.break.levels:B ext.builtin.array:L ext.op.index.append:B ext.stmt.for.collection:B ext.builtin.print_r:L \
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.lexical.string.long", "ext.op.lambda", "ext.op.tuple", "ext.stmt.class.bases.open", "ext.stmt.class.bases.close", "ext.stmt.del", "ext.stmt.nonlocal", "ext.stmt.with", "ext.stmt.with.as", "ext.stmt.yield", "ext.stmt.yield.from", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "ext.op.comprehension.async", "ext.op.comprehension.for", "ext.op.comprehension.in", "ext.op.comprehension.if", "ext.syntax.array.spread", "ext.syntax.map.spread", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close", "ext.op.if_else", "ext.op.identical.negated", "ext.op.in.negated", "ext.op.assign.expression", "ext.literal.ellipsis",
            ...
            "ext.op.await", "ext.stmt.async", "ext.stmt.match", "ext.stmt.match.case", "ext.stmt.type_alias", "ext.stmt.global", "ext.stmt.decorator", "ext.stmt.const", "ext.stmt.switch", "ext.stmt.case", "ext.stmt.default", "ext.op.plus",
