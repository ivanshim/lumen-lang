...
pub const BUILTIN_LABELS: [(&str, Prim); 155] = [
    ...
    ("builtin.error", Prim::Raise), ("builtin.extern", Prim::External), ("ext.builtin.slice", Prim::SliceValue), ("builtin.range", Prim::Span), ("builtin.real", Prim::MakeReal),
