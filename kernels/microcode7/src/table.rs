...
const EXT_TAGS: &str = "\
ext.op.sequence.operands:L ext.op.sequence.values:B ext.op.sequence.concat:L ext.op.sequence.order:L ext.op.sequence.repeat:L ext.op.sequence.assign:L ext.op.sequence.delete:L ext.op.sequence.index:L ext.op.sequence.unhashable:L ext.op.sequence.missing:L ext.op.sequence.unready:L ext.op.sequence.empty:L ext.op.sequence.subscript:L ext.builtin.tuple:L ext.builtin.hash:L ext.builtin.index:L ext.builtin.count:L ext.builtin.min:L ext.builtin.max:L ext.builtin.sorted:L ext.builtin.reversed:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 80] = [
    ("ext.builtin.tuple", Prim::Frozen), ("ext.builtin.hash", Prim::Fingerprint), ("ext.builtin.index", Prim::Locate), ("ext.builtin.count", Prim::Occurrences), ("ext.builtin.min", Prim::Least), ("ext.builtin.max", Prim::Greatest), ("ext.builtin.sorted", Prim::Ordered), ("ext.builtin.reversed", Prim::Backwards),
