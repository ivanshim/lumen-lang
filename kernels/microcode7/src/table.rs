...
const EXT_TAGS: &str = "\
ext.builtin.dict.keys:L ext.builtin.dict.values:L ext.builtin.dict.items:L ext.op.iterator.changed:L ext.op.iterator.views:L \
ext.builtin.tuple:L ext.builtin.set:L ext.builtin.sorted:L ext.builtin.all:L ext.builtin.min:L ext.builtin.max:L ext.builtin.dict:L ext.builtin.repr:L ext.builtin.join:L \
ext.builtin.iter:L ext.builtin.next:L ext.builtin.map:L ext.builtin.filter:L ext.builtin.zip:L ext.builtin.enumerate:L ext.builtin.reversed:L ext.op.iterator.give:L ext.op.iterator.next:L ext.op.iterator.item:L ext.op.iterator.reverse:L ext.op.iterator.call:L ext.op.iterator.length:L ext.op.iterator.stop:L ext.op.iterator.end:L ext.op.iterator.unwalkable:L ext.op.iterator.unnextable:L ext.op.iterator.unsized:L ext.op.iterator.unready:L ext.op.iterator.kind:L ext.builtin.zip.strict:L ext.builtin.zip.short:L ext.builtin.zip.long:L ext.builtin.enumerate.start:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 91] = [
    ("ext.builtin.iter", Prim::IteratorOf), ("ext.builtin.next", Prim::TakeNext), ("ext.builtin.map", Prim::Mapped), ("ext.builtin.filter", Prim::Filtered), ("ext.builtin.zip", Prim::Zipped), ("ext.builtin.enumerate", Prim::Enumerated), ("ext.builtin.reversed", Prim::Reversed), ("ext.builtin.tuple", Prim::Tupled), ("ext.builtin.set", Prim::Unique), ("ext.builtin.sorted", Prim::Ordered), ("ext.builtin.all", Prim::EveryTrue), ("ext.builtin.min", Prim::Least), ("ext.builtin.max", Prim::Greatest), ("ext.builtin.dict", Prim::Dictionary), ("ext.builtin.repr", Prim::Represented), ("ext.builtin.join", Prim::JoinedWalk), ("ext.builtin.dict.keys", Prim::KeyWindow), ("ext.builtin.dict.values", Prim::ValueWindow), ("ext.builtin.dict.items", Prim::PairWindow), ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.any", Prim::SomeTrue),
