...
const EXT_TAGS: &str = "\
ext.builtin.format:L ext.text.format:L ext.text.format.invalid:L ext.text.format.unknown:L ext.text.format.kinds:L ext.text.format.unready:L ext.text.format.precision.integer:L ext.text.format.precision.missing:L ext.text.format.sign.string:L ext.text.format.alternate.string:L ext.text.format.align.string:L ext.text.format.sign.character:L ext.text.format.alternate.character:L ext.text.format.character:L ext.text.format.spec.type:L ext.text.format.numbered.auto:L ext.text.format.numbered.manual:L ext.text.format.index:L ext.text.format.key:L ext.text.format.brace.open:L ext.text.format.brace.close:L ext.text.format.conversion:L ext.text.format.recursion:L ext.op.rem.format.few:L ext.op.rem.format.many:L ext.op.rem.format.mapping:L ext.op.rem.format.number:L ext.op.rem.format.integer:L ext.op.rem.format.real:L ext.op.rem.format.character:L ext.op.rem.format.star:L ext.op.rem.format.incomplete:L ext.op.rem.format.code:L
ext.lexical.number.point.open:B
ext.op.rem.format.nan:L ext.op.rem.format.infinity:L
ext.text.format.zero.integer:L ext.text.format.zero.string:L
...
pub const BUILTIN_LABELS: [(&str, Prim); 73] = [
    ("ext.builtin.format", Prim::FormatValue), ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.any", Prim::SomeTrue),
