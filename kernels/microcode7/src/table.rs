...
ext.builtin.include.demanded:L ext.builtin.include.demanded.missing:L \
 ...
 ext.builtin.globals:L ext.builtin.locals:L ext.builtin.exec:L ext.builtin.compile:L ext.builtin.compile.modes:L ext.builtin.compile.parameters:L ext.builtin.compile.kind:L ext.builtin.source.syntax:L ext.builtin.source.unready:L ext.builtin.import:L ext.system.module.doc:L ext.system.module.builtins:L ext.op.sequence.values:B ext.op.sequence.concat:L ext.op.sequence.repeat:L ext.op.sequence.index:L ext.op.sequence.delete:L ext.op.sequence.subscript:L ext.op.sequence.missing:L ext.op.sequence.assign:L ";
