...
pub const BUILTIN_LABELS: [(&str, Prim); 85] = [
    ...
    ("ext.builtin.globals", Prim::WorldNames), ("ext.builtin.locals", Prim::NearNames), ("ext.builtin.vars", Prim::NamesOf), ("ext.builtin.exec", Prim::RunText), ("ext.builtin.compile", Prim::PrepareText), ("ext.builtin.dir", Prim::NamesListed), ("ext.builtin.id", Prim::IdentityOf), ("ext.builtin.hash", Prim::HashOf), ("ext.builtin.input", Prim::ReadLine), ("ext.builtin.breakpoint", Prim::BreakHere), ("ext.builtin.help", Prim::HelpHere), ("ext.builtin.import", Prim::ImportNamed), ("ext.builtin.sorted", Prim::Ordered), 
