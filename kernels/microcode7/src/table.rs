...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.lexical.string.long", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close",
            ...
            "ext.literal.ellipsis", "ext.stmt.with", "ext.stmt.with.as", "ext.stmt.global", "ext.stmt.decorator", "ext.lexical.line_continuation", "ext.op.matrix", "ext.op.tuple", "ext.stmt.const", "ext.stmt.switch", "ext.stmt.case", "ext.stmt.default", "ext.op.plus",
