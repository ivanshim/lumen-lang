...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        // The letter ending an imaginary numeral is not among these.
        // It belongs to a numeral's spelling, read only where figures
        // stand before it, so a bare `j` is a name like any other.
