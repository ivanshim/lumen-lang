...
const EXT_TAGS: &str = "\
ext.literal.unimplemented:L ext.builtin.object:L ext.builtin.hash.method:L ext.builtin.hash.result:L ext.builtin.bool.method:L ext.builtin.bool.result:L ext.builtin.bool.base:L ext.builtin.len.method:L ext.builtin.len.negative:L ext.op.eq.method:L ext.op.ne.method:L ext.op.order.unsupported:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 153] = [
            ...
            ("ext.builtin.object", Prim::PlainObject),
