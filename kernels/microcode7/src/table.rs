...
const EXT_TAGS: &str = "\
ext.lexical.string.long:L ext.op.lambda:L ext.op.tuple:L ext.stmt.class.detail.call:L ext.stmt.class.detail.root:L ext.stmt.class.detail.mro:L ext.stmt.class.detail.order:L ext.stmt.class.detail.name:L ext.stmt.class.detail.qualified:L ext.stmt.class.detail.bases:L ext.stmt.class.detail.namespace:L ext.stmt.class.detail.kind:L ext.stmt.class.detail.allocate:L ext.stmt.class.detail.subclass:L ext.stmt.class.detail.slots:L ext.stmt.class.detail.set:L ext.stmt.class.detail.remove:L ext.stmt.class.detail.get:L ext.stmt.class.detail.getitem:L ext.stmt.class.detail.doc:L ext.stmt.class.detail.module:L ext.stmt.class.detail.defaults:L ext.stmt.class.detail.code:L ext.stmt.class.detail.argcount:L ext.stmt.class.detail.varnames:L ext.stmt.class.detail.receiver:L ext.stmt.class.detail.function:L ext.stmt.class.detail.locals:L ext.stmt.class.detail.main:L ext.stmt.class.detail.mro.amiss:L ext.stmt.class.detail.attribute.amiss:L ext.stmt.class.detail.unready:L ext.builtin.isinstance:L ext.builtin.issubclass:L ext.builtin.callable:L ext.builtin.getattr:L ext.builtin.setattr:L ext.builtin.delattr:L ext.builtin.hasattr:L ext.builtin.vars:L ext.builtin.dir:L ext.builtin.staticmethod:L ext.builtin.classmethod:L ext.builtin.property:L ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.stmt.del:L ext.stmt.nonlocal:L ext.stmt.nonlocal.unrun:L ext.stmt.with:L ext.stmt.with.as:L ext.stmt.yield:L ext.stmt.yield.from:L ext.stmt.yield.unrun:L ext.system.scope.unready:L ext.op.index.slice.ellipsis:L ext.op.index.slice:L ext.op.index.slice.zero:L ext.op.index.slice.bounds:L ext.op.index.slice.unsupported:L ext.op.index.slice.assign:L ext.op.index.slice.length:L ext.op.index.slice.detached:L ext.op.comprehension.async:L ext.op.comprehension.async.unavailable:L ext.op.comprehension.target.unavailable:L ext.builtin.sum.non_number:L ext.builtin.range.non_integer:L ext.builtin.range.zero_step:L ext.op.comprehension.for:L ext.op.comprehension.in:L ext.op.comprehension.if:L ext.syntax.set:B ext.syntax.array.spread:L ext.syntax.map.spread:L ext.syntax.collection.unwalkable:L ext.syntax.map.spread.unmapped:L ext.op.comprehension.unpack.amiss:L ext.builtin.range.value:B ext.builtin.sum:L ext.builtin.list:L ext.builtin.any:L ext.op.await:L ext.stmt.async:L ext.stmt.loop.else:B ext.stmt.del.unrun:L ext.stmt.binding.unrun:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 84] = [
