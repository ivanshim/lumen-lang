...
ext.builtin.exceptions:L ext.builtin.exceptions.args:L ext.builtin.exceptions.cause:L ext.builtin.class.name:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.repr:L ext.system.fault.class.index:L ext.system.fault.class.key:L ext.system.fault.class.name:L ext.system.fault.class.attribute:L ext.system.fault.class.stop:L ext.system.fault.division:L ext.system.fault.index:L ext.system.fault.name:L ext.system.fault.attribute:L ext.system.fault.kind:L ext.builtin.exceptions.unready:L ext.system.complaint.warning:L ext.system.complaint.notice:L ext.system.complaint.deprecated:L ext.system.complaint.fatal:L ext.system.complaint.reading:L ext.system.fault.class:L ext.system.fault.operands:L ext.op.increment.text:L ext.op.decrement.text:L ext.system.fault.class.arithmetic:L ext.system.fault.class.division:L ext.system.fault.class.kind:L ext.system.fault.class.value:L ext.system.fault.modulo:L ext.system.fault.shift:L ext.system.fault.class.walk:L ext.op.walk.giver.unwalkable:L ext.builtin.time_limit:L ext.system.kind.brief:L ext.builtin.file.read:L ext.builtin.file.write:L \
