...
ext.builtin.shell:L ext.lexical.escape.byte:L ext.lexical.escape.octal:B ext.system.text.bytes:B ext.lexical.prologue.brief:L ext.lexical.prologue.brief.setting:L ext.lexical.interpolating.index.amiss:L ext.builtin.eval.place:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 65] = [
    ...
    ("ext.builtin.shell", Prim::Shelled),
];
