...
const EXT_TAGS: &str = "\
ext.builtin.zip:L ext.builtin.sorted:L ext.builtin.max:L ext.builtin.reversed:L ext.builtin.order.key:L ext.builtin.order.reverse:L ext.builtin.order.unready:L ext.builtin.reversed.unready:L ext.builtin.reversed.iterator:L ext.op.tuple.value:B ext.builtin.map.items:L ext.builtin.map.set.empty:L ext.builtin.map.items.view:L ext.builtin.map.popitem.empty:L ext.builtin.map.keys:L ext.builtin.map.values:L ext.builtin.map.keys.view:L ext.builtin.map.values.view:L ext.builtin.map.new:L ext.builtin.map.fromkeys:L ext.builtin.map.get:L ext.builtin.map.setdefault:L ext.builtin.map.pop:L ext.builtin.map.popitem:L ext.builtin.map.update:L ext.builtin.map.clear:L ext.builtin.map.copy:L ext.builtin.map.pairs.amiss:L ext.syntax.map.value_keys:B ext.syntax.map.resized:L ext.syntax.map.missing:L ext.syntax.map.unhashable:L ext.syntax.map.key.unready:L ext.syntax.map.ordering:L ext.lexical.string.long:L ext.op.lambda:L ext.op.tuple:L ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.stmt.class.unready:L ext.stmt.del:L ext.stmt.nonlocal:L ext.stmt.nonlocal.unrun:L ext.stmt.with:L ext.stmt.with.as:L ext.stmt.yield:L ext.stmt.yield.from:L ext.stmt.yield.unrun:L ext.system.scope.unready:L ext.op.index.slice.ellipsis:L ext.op.index.slice:L ext.op.index.slice.zero:L ext.op.index.slice.bounds:L ext.op.index.slice.unsupported:L ext.op.index.slice.assign:L ext.op.index.slice.length:L ext.op.index.slice.detached:L ext.op.comprehension.async:L ext.op.comprehension.async.unavailable:L ext.op.comprehension.target.unavailable:L ext.builtin.sum.non_number:L ext.builtin.range.non_integer:L ext.builtin.range.zero_step:L ext.op.comprehension.for:L ext.op.comprehension.in:L ext.op.comprehension.if:L ext.syntax.set:B ext.syntax.array.spread:L ext.syntax.map.spread:L ext.syntax.collection.unwalkable:L ext.syntax.map.spread.unmapped:L ext.op.comprehension.unpack.amiss:L ext.builtin.range.value:B ext.builtin.sum:L ext.builtin.list:L ext.builtin.any:L ext.op.await:L ext.stmt.async:L ext.stmt.loop.else:B ext.stmt.del.unrun:L ext.stmt.binding.unrun:L \
...
ext.op.if_else:L ext.op.lambda.unsupported:L ext.op.lambda.enclosing:L ext.op.identical.negated:L ext.op.identical.unsupported:L ext.op.in:L ext.op.in.negated:L ext.op.in.unsupported:L ext.op.compare.chained:B ext.op.assign.expression:L ext.literal.ellipsis:L ext.op.rem.formats_text:B ext.op.rem.format.unsupported:L ext.op.rem.format.arguments:L ext.lexical.number.exponent:L ext.op.plus:L ext.stmt.break.levels:B ext.builtin.array:L ext.op.index.append:B ext.stmt.for.collection:B ext.builtin.print_r:L ext.stmt.terminator:L ext.stmt.annotation:L ext.stmt.annotation.amiss:L ext.stmt.annotation.target.unready:L ext.stmt.function.returns:L ext.stmt.class:L ext.stmt.class.extends:L ext.stmt.class.new:L ext.stmt.class.this:L ext.stmt.class.this.explicit:B ext.stmt.class.bases.open:L ext.stmt.class.bases.close:L ext.op.member.pipes:B ext.stmt.class.unready:L ext.lexical.line_continuation:L ext.lexical.number.point.bare:B ext.lexical.number.separator.after_prefix:B ext.op.bit.whole:B ext.builtin.print.real_point:B ext.builtin.print.collections:B ext.lexical.number.imaginary:L ext.lexical.number.imaginary.unready:L ext.lexical.number.point_edge:B ext.lexical.number.separator.strict:B ext.lexical.number.amiss.leading_zero:L ext.lexical.number.amiss.binary:L ext.lexical.number.amiss.binary.digit:L ext.lexical.number.amiss.octal:L ext.lexical.number.amiss.octal.digit:L ext.lexical.number.amiss.hex:L \
...
pub const BUILTIN_LABELS: [(&str, Prim); 88] = [
    ("ext.builtin.max", Prim::Largest), ("ext.builtin.reversed", Prim::Backward),
    ("ext.builtin.sorted", Prim::Ordered), ("ext.builtin.zip", Prim::Zipped),
    ("ext.builtin.map.items", Prim::MapCall(11)),
    ("ext.builtin.map.values", Prim::MapCall(10)), ("ext.builtin.map.keys", Prim::MapCall(9)),
    ("ext.builtin.map.new", Prim::MapCall(0)), ("ext.builtin.map.fromkeys", Prim::MapCall(1)), ("ext.builtin.map.get", Prim::MapCall(2)), ("ext.builtin.map.setdefault", Prim::MapCall(3)), ("ext.builtin.map.pop", Prim::MapCall(4)), ("ext.builtin.map.popitem", Prim::MapCall(5)), ("ext.builtin.map.update", Prim::MapCall(6)), ("ext.builtin.map.clear", Prim::MapCall(7)), ("ext.builtin.map.copy", Prim::MapCall(8)),
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.lexical.string.long", "ext.op.lambda", "ext.op.tuple", "ext.stmt.class.bases.open", "ext.stmt.class.bases.close", "ext.stmt.del", "ext.stmt.nonlocal", "ext.stmt.with", "ext.stmt.with.as", "ext.stmt.yield", "ext.stmt.yield.from", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "ext.op.comprehension.async", "ext.op.comprehension.for", "ext.op.comprehension.in", "ext.op.comprehension.if", "ext.syntax.array.spread", "ext.syntax.map.spread", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close", "ext.op.if_else", "ext.op.identical.negated", "ext.op.in.negated", "ext.op.assign.expression", "ext.literal.ellipsis", "ext.lexical.line_continuation",
