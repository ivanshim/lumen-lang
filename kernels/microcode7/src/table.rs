...
ext.builtin.exceptions.note:L ext.builtin.exceptions.notes:L ext.builtin.exceptions.note.invalid:L ext.builtin.exceptions.notes.invalid:L ext.builtin.exceptions.traceback:L ext.builtin.exceptions.traceback.with:L ext.builtin.exceptions.suppress:L ext.builtin.exceptions.name:L ext.builtin.exceptions.object:L ext.builtin.exceptions.os:L ext.builtin.exceptions.group.members:L ext.builtin.exceptions.group.message:L ext.builtin.exceptions.group.subgroup:L ext.builtin.exceptions.group.split:L ext.builtin.exceptions.group.derive:L ext.builtin.exceptions.group.invalid:L ext.builtin.exceptions.info:L ext.builtin.exceptions.current:L ext.stmt.throw.invalid:L ext.system.recursion.limit:N ext.system.recursion.exceeded:L ext.system.collection.repr:B ext.system.fault.trace:L ext.builtin.exceptions.os.message:L ext.builtin.exceptions.group.summary:L ext.stmt.catch.amiss:L ext.stmt.catch.group.amiss:L ext.builtin.exceptions:L ext.builtin.exceptions.args:L ext.builtin.exceptions.cause:L ext.builtin.class.name:L ext.builtin.iter:L ext.builtin.next:L ext.builtin.repr:L ext.system.fault.class.index:L ext.system.fault.class.key:L ext.system.fault.class.name:L ext.system.fault.class.attribute:L ext.system.fault.class.stop:L ext.system.fault.division:L ext.system.fault.index:L ext.system.fault.name:L ext.system.fault.attribute:L ext.system.fault.kind:L ext.builtin.exceptions.unready:L ext.system.complaint.warning:L ext.system.complaint.notice:L ext.system.complaint.deprecated:L ext.system.complaint.fatal:L ext.system.complaint.reading:L ext.system.fault.class:L ext.system.fault.operands:L ext.op.increment.text:L ext.op.decrement.text:L ext.system.fault.class.arithmetic:L ext.system.fault.class.division:L ext.system.fault.class.kind:L ext.system.fault.class.value:L ext.system.fault.modulo:L ext.system.fault.shift:L ext.system.fault.class.walk:L ext.op.walk.giver.unwalkable:L ext.builtin.time_limit:L ext.system.kind.brief:L ext.builtin.file.read:L ext.builtin.file.write:L \
...
ext.stmt.function.closes_over:B ext.stmt.function.local.unbound:L ext.stmt.function.free.unbound:L ext.stmt.nonlocal.amiss:L ext.stmt.function.own_names:B ext.stmt.static.read_in:B \
...
pub const BUILTIN_LABELS: [(&str, Prim); 128] = [
    ("ext.builtin.map", Prim::Dictionary), ("ext.builtin.sum", Prim::Total), ("ext.builtin.list", Prim::Listed), ("ext.builtin.next", Prim::Following), ("ext.builtin.iter", Prim::Iterator), ("ext.builtin.tuple", Prim::Tupled), ("ext.builtin.any", Prim::SomeTrue),
    ("ext.builtin.sorted", Prim::SortedValues),
    ("ext.builtin.method.upper", Prim::ValueMethod), ("ext.builtin.method.lower", Prim::ValueMethod), ("ext.builtin.method.strip", Prim::ValueMethod), ("ext.builtin.method.lstrip", Prim::ValueMethod), ("ext.builtin.method.rstrip", Prim::ValueMethod), ("ext.builtin.method.split", Prim::ValueMethod), ("ext.builtin.method.rsplit", Prim::ValueMethod), ("ext.builtin.method.join", Prim::ValueMethod), ("ext.builtin.method.replace", Prim::ValueMethod), ("ext.builtin.method.startswith", Prim::ValueMethod), ("ext.builtin.method.endswith", Prim::ValueMethod), ("ext.builtin.method.find", Prim::ValueMethod), ("ext.builtin.method.rfind", Prim::ValueMethod), ("ext.builtin.method.index", Prim::ValueMethod), ("ext.builtin.method.count", Prim::ValueMethod), ("ext.builtin.method.isdigit", Prim::ValueMethod), ("ext.builtin.method.isalpha", Prim::ValueMethod), ("ext.builtin.method.isalnum", Prim::ValueMethod), ("ext.builtin.method.isspace", Prim::ValueMethod), ("ext.builtin.method.islower", Prim::ValueMethod), ("ext.builtin.method.isupper", Prim::ValueMethod), ("ext.builtin.method.title", Prim::ValueMethod), ("ext.builtin.method.capitalize", Prim::ValueMethod), ("ext.builtin.method.center", Prim::ValueMethod), ("ext.builtin.method.ljust", Prim::ValueMethod), ("ext.builtin.method.rjust", Prim::ValueMethod), ("ext.builtin.method.zfill", Prim::ValueMethod), ("ext.builtin.method.format", Prim::ValueMethod), ("ext.builtin.method.encode", Prim::ValueMethod), ("ext.builtin.method.append", Prim::ValueMethod), ("ext.builtin.method.extend", Prim::ValueMethod), ("ext.builtin.method.insert", Prim::ValueMethod), ("ext.builtin.method.pop", Prim::ValueMethod), ("ext.builtin.method.remove", Prim::ValueMethod), ("ext.builtin.method.sort", Prim::ValueMethod), ("ext.builtin.method.reverse", Prim::ValueMethod), ("ext.builtin.method.copy", Prim::ValueMethod), ("ext.builtin.method.clear", Prim::ValueMethod), ("ext.builtin.method.get", Prim::ValueMethod), ("ext.builtin.method.keys", Prim::ValueMethod), ("ext.builtin.method.values", Prim::ValueMethod), ("ext.builtin.method.items", Prim::ValueMethod), ("ext.builtin.method.setdefault", Prim::ValueMethod), ("ext.builtin.method.update", Prim::ValueMethod), ("ext.builtin.method.bit_length", Prim::ValueMethod), ("ext.builtin.method.is_integer", Prim::ValueMethod), ("ext.builtin.method.hex", Prim::ValueMethod), ("ext.builtin.method.as_integer_ratio", Prim::ValueMethod),
    ("ext.builtin.exceptions.info", Prim::FaultInfo), ("ext.builtin.exceptions.current", Prim::FaultCurrent),
    ("ext.builtin.repr", Prim::Repr),
