...
const EXT_TAGS: &str = "
ext.stmt.class.suite:L ext.stmt.class.suite.unsupported:L ext.stmt.with.group.open:L ext.stmt.with.group.close:L ext.stmt.with.unsupported:L ext.stmt.nonlocal.unsupported:L ext.stmt.delete:L ext.stmt.delete.unsupported:L ext.stmt.yield.unsupported:L ext.syntax.tuple.separator:L ext.syntax.tuple.unsupported:L ext.syntax.value.spread:L ext.syntax.value.spread.unsupported:L ext.op.index.spread.unsupported:L ext.op.conditional:L ext.stmt.function.short.bare:B ext.lexical.string.triple:B ext.lexical.string.raw_prefix:L ext.lexical.string.text_prefix:L ext.syntax.string.adjacent:B ext.op.identity.unsupported:L ext.op.comparison.chain:B ext.stmt.for.range.stop:B \
\
...
ext.stmt.function.closes_over:B ext.stmt.function.local.unbound:L ext.stmt.function.free.unbound:L ext.stmt.nonlocal.amiss ext.stmt.nonlocal.module:L ext.stmt.function.own_names:B ext.stmt.static.read_in:B \
...
pub const BUILTIN_LABELS: [(&str, Prim); 73] = [
