...
ext.stmt.function.carries.pairs:L ext.stmt.function.keyword_only:L ext.stmt.function.positional_only:L ext.syntax.call.bind_names:B ext.syntax.call.spread:L ext.syntax.call.spread.pairs:L ext.syntax.call.amiss:L ext.syntax.call.amiss.missing:L ext.syntax.call.amiss.unknown:L ext.syntax.call.amiss.duplicate:L ext.syntax.call.amiss.builtin:L ext.builtin.print.sep:L ext.builtin.print.end:L ext.builtin.print.file:L ext.builtin.print.flush:L ext.builtin.print.file.error:L ext.builtin.print.file.output:L ext.builtin.print.file.unready:L ext.builtin.print.sep.amiss:L ext.builtin.print.end.amiss:L ext.builtin.to_int.infinity:L ext.builtin.to_int.nan:L ext.builtin.to_int.base:L ext.builtin.to_int.base.amiss:L ext.builtin.to_int.text.amiss:L ext.builtin.to_int.text.required:L ext.builtin.to_real.text:B ext.builtin.to_real.text.amiss:L ext.builtin.to_string.object:L ext.builtin.to_string.encoding:L ext.builtin.to_string.errors:L ext.builtin.to_string.unready:L ext.builtin.range.value:B ext.builtin.range.zero:L ext.builtin.range.integer:L ext.builtin.range.index:L ext.syntax.call.spread.amiss:L ext.syntax.call.spread.pairs.amiss:L ext.stmt.function.defaults.amiss:L ext.stmt.function.parameters.amiss:L ext.stmt.function.carries:L ext.stmt.function.short:L ext.stmt.class.trait:L ext.stmt.class.uses:L ext.stmt.class.uses.alias:L ext.stmt.class.interface:L ext.stmt.class.implements:L ext.op.compare:L ext.builtin.unset:L ext.lexical.template:B ext.lexical.prologue.echo:L ext.lexical.prologue.folded:B ext.lexical.line_continuation:L ext.lexical.number.separator.after_prefix:B ext.op.bit.whole:B ext.op.bit.whole.room:L ext.op.plus.non_number:L ext.stmt.function.async:L ext.stmt.function.async.unavailable:L ext.op.bit.whole.amiss:L ext.op.bit.whole.large:L ext.op.matrix:L ext.op.matrix.unavailable:L ext.op.otherwise:L ext.op.bit.and:L ext.op.bit.or:L ext.op.bit.xor:L ext.op.bit.not:L ext.op.bit.left.unready:L ext.op.bit.left:L ext.op.bit.right:L ext.op.bit.shift.numbers:B ext.op.identical:L ext.op.not_identical:L ext.system.kind.spelled:B ext.builtin.args.all:L ext.builtin.args.count:L ext.builtin.args.at:L ext.builtin.args.all.outside:L ext.builtin.args.count.outside:L ext.builtin.args.at.outside:L ext.builtin.args.at.below:L ext.builtin.args.at.beyond:L ext.op.assign.value:B ext.op.index.plain_keys:B ext.stmt.assign.chain:B ext.op.matrix.unready:L ext.op.bit.operands:L \
