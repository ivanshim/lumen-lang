...
pub const BUILTIN_LABELS: [(&str, Prim); 268] = [
    ...
    ("ext.builtin.file.exists", Prim::There), ("ext.builtin.file.kind", Prim::PathSort), ("ext.system.fault.current", Prim::FaultHeld), ("ext.builtin.host.info", Prim::HostRow), ("ext.builtin.file.remove", Prim::Gone),
