...
ext.op.comprehension.for:L ext.op.comprehension.in:L ext.op.comprehension.if:L ext.syntax.set:B ext.op.tuple:L ext.op.bit.or.maps:B ext.builtin.print.separator:L ext.builtin.print.end:L ext.builtin.print.option.type:L ext.builtin.map:L ext.builtin.map.arguments.amiss:L ext.builtin.map.pair.amiss:L ext.syntax.array.spread:L ext.syntax.map.spread:L ext.syntax.collection.unwalkable:L ext.syntax.map.spread.unmapped:L ext.op.comprehension.unpack.amiss:L ext.builtin.range.value:B ext.builtin.sum:L ext.builtin.list:L ext.builtin.any:L \
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.op.tuple", "ext.op.index.slice.ellipsis", "ext.op.index.slice", "ext.op.comprehension.async", "ext.op.comprehension.for", "ext.op.comprehension.in", "ext.op.comprehension.if", "ext.syntax.array.spread", "ext.syntax.map.spread", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close",
