...
pub const BUILTIN_LABELS: [(&str, Prim); 202] = [
    ...
    ("ext.builtin.ascii", Prim::AsciiText),
    ("ext.system.unicode.maximum", Prim::UnicodeLimit),
    ("ext.builtin.method.casefold", Prim::ValueMethod),
    ("ext.builtin.method.swapcase", Prim::ValueMethod),
    ("ext.builtin.method.isdecimal", Prim::ValueMethod),
    ("ext.builtin.method.isnumeric", Prim::ValueMethod),
    ("ext.builtin.method.isprintable", Prim::ValueMethod),
    ("ext.builtin.method.isidentifier", Prim::ValueMethod),
    ("ext.builtin.method.isascii", Prim::ValueMethod),
    ("ext.builtin.method.expandtabs", Prim::ValueMethod),
    ("ext.builtin.method.maketrans", Prim::ValueMethod),
    ("ext.builtin.method.translate", Prim::ValueMethod),
