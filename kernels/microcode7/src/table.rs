...
ext.stmt.function.carries.pairs:L ext.stmt.function.keyword_only:L ext.stmt.function.positional_only:L ext.syntax.call.bind_names:B ext.syntax.call.spread:L ext.syntax.call.spread.pairs:L ext.syntax.call.amiss:L ext.syntax.call.amiss.missing:L ext.syntax.call.amiss.unknown:L ext.syntax.call.amiss.duplicate:L ext.syntax.call.amiss.builtin:L ext.builtin.print.sep:L ext.builtin.print.end:L ext.builtin.print.file:L ext.builtin.print.flush:L ext.builtin.print.file.error:L ext.builtin.print.file.output:L ext.builtin.print.file.unready:L ext.builtin.print.sep.amiss:L ext.builtin.print.end.amiss:L ext.builtin.to_int.base:L ext.builtin.to_int.base.amiss:L ext.builtin.to_int.text.amiss:L ext.builtin.to_int.text.required:L ext.builtin.to_real.text:B ext.builtin.to_real.text.amiss:L ext.builtin.to_string.object:L ext.builtin.to_string.encoding:L ext.builtin.to_string.errors:L ext.builtin.to_string.unready:L ext.builtin.range.value:B ext.builtin.range.zero:L ext.builtin.range.integer:L ext.builtin.range.index:L ext.builtin.range.members:L ext.builtin.range.kinds:L ext.builtin.range.missing:L ext.builtin.range.unready:L ext.builtin.range.length:L ext.builtin.max:L ext.builtin.min:L ext.builtin.repr:L ext.builtin.reversed:L ext.builtin.tuple:L ext.builtin.set:L ext.builtin.max.empty:L ext.builtin.min.empty:L ext.syntax.call.spread.amiss:L ext.syntax.call.spread.pairs.amiss:L ext.stmt.function.defaults.amiss:L ext.stmt.function.parameters.amiss:L ext.stmt.function.carries:L ext.stmt.function.short:L ext.stmt.class.trait:L ext.stmt.class.uses:L ext.stmt.class.uses.alias:L ext.stmt.class.interface:L ext.stmt.class.implements:L ext.op.compare:L ext.builtin.unset:L ext.lexical.template:B ext.lexical.prologue.echo:L ext.lexical.prologue.folded:B \
...
pub const BUILTIN_LABELS: [(&str, Prim); 78] = [
    ("ext.builtin.max", Prim::Highest),
    ("ext.builtin.min", Prim::Lowest),
    ("ext.builtin.repr", Prim::Representation),
    ("ext.builtin.reversed", Prim::Turned),
    ("ext.builtin.tuple", Prim::AsTuple),
    ("ext.builtin.set", Prim::AsSet),
