...
ext.lexical.number.point.bare:B ext.lexical.number.separator.after_prefix:B ext.stmt.class.unready:L ext.op.bit.whole:B ext.op.matrix:L ext.op.matrix.unready:L ext.lexical.line_continuation:L ext.lexical.number.exponent:L ext.op.plus:L ext.stmt.break.levels:B ext.builtin.array:L ext.op.index.append:B ext.stmt.for.collection:B ext.builtin.print_r:L \
...
impl Table {
    ...
    fn precedence_tables(&mut self) -> Result<(), String> {
        ...
        let symbol_labels = ["ext.op.index.slice.ellipsis", "ext.op.index.slice", "syntax.group.open", "syntax.group.close", "syntax.call.open", "syntax.call.separator", "syntax.call.close",
            ...
            "ext.stmt.global", "ext.stmt.decorator", "ext.lexical.line_continuation", "ext.op.matrix", "ext.stmt.const", "ext.stmt.switch", "ext.stmt.case", "ext.stmt.default", "ext.op.plus",
